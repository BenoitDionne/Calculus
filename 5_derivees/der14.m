...
% The graph of the tangente to the curve y=cos(x) at x = 13 pi / 6
x = 2*pi-0.5:0.1:2*pi+2;
y = cos(13*pi/6) - 0.5*( x - 13*pi/6);
plot(x,y,'r')
text(13*pi/6+0.2, cos(13*pi/6), '(13\pi/6,cos(13\pi/6))');

% The point x = 2 pi
text(2*pi-0.3 , -0.07, '2\pi');
y = 0:1:1;
x = 0*y + 2*pi;
plot(x,y,'--r')
