\nonumsection{Chapter~\ref{CHAPvecteurs} : Vecteurs}

\nonumsubsection{Équation d'une droite}
...
\nonumsubsection{Équation d'un plan}
...
\end{align}
Nous obtenons $\DS x_3 = - \frac{3}{5} - \frac{2}{5} x_1$ de
