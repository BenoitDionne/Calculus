...
\hline
\rule[-1em]{0ex}{3em} \DS x_n = 1 + \frac{1}{n} &
\DS 2 & \DS \frac{3}{2} &
\DS \frac{4}{3} & \DS \frac{5}{4} &
\ldots & \DS \frac{101}{100} &
\ldots & \DS \frac{10001}{10000} & \ldots \\
\hline
...
\hline
\rule[-1em]{0ex}{3em} \DS x_n = 1 - \frac{1}{n^2} &
\DS 0 & \DS \frac{3}{4} &
\DS \frac{8}{9} & \ldots & \DS \frac{9999}{10000} &
\ldots & \DS \frac{99999999}{100000000} & \ldots \\
\hline
...
$\DS \left\{x_n\right\}_{n=1}^\infty$
qui tend vers $1$ que nous choisissons, le résultat sera toujours une
suite $\DS \left\{g(x_n)\right\}_{n=1}^\infty$ qui tend vers
...
$\DS \left\{x_n\right\}_{n=1}^\infty$ approche $1$.
\label{egg_cont1}
\end{egg}
...
$\DS \left\{x_n\right\}_{n=1}^\infty$ de
...
$\DS \lim_{x\rightarrow 0} \frac{\sin(x)}{x}$ ?

Dans le tableau suivant, nous évaluons $g$ à chacun des
termes de la suite $\DS \left\{x_n\right\}_{n=1}^\infty$ qui
...
\end{array}
\]
La suite $\DS \left\{g(x_n)\right\}_{n=1}^\infty$
tend vers $1$.  Nous allons montrer plus loin que cela est vrai quelle que
soit la suite $\DS \left\{x_n\right\}_{n=1}^\infty$ qui tend
...
suite $\DS \left\{x_n\right\}_{n=1}^\infty$ où
$\DS x_n = \frac{1}{2n \pi}$ pour $n=1$, $2$, $3$, \ldots.
La suite $\DS \left\{g(x_n)\right\}_{n=1}^\infty$ tend
vers $0$ car $g(x_n) = 0$ pour tout $n$.
\[
\begin{array}{l|l|l|l|l|l|l|l|l|l}
n & 1 & 2 & 3 & 4 & \ldots & 100 & \ldots & 10000 & \ldots \\
\hline
\rule[-1em]{0ex}{3em} \DS x_n = \frac{1}{2n \pi} &
\DS \frac{1}{2\pi} & \DS \frac{1}{4\pi} &
\DS \frac{1}{6\pi} & \DS \frac{1}{8\pi} &
\ldots & \DS \frac{1}{200\pi} &
\ldots & \DS \frac{1}{20000\pi} & \ldots \\
\hline
...
maintenant avec la suite $\DS \left\{x_n\right\}_{n=1}^\infty$
où $x_n = 2/((4n+1)\pi)$ pour $n=1$, $2$, $3$, \ldots  La suite
$\DS \left\{x_n\right\}_{n=1}^\infty$ tend vers $0$.  Par
contre, le tableau suivant semble indiquer que
$\DS \left\{g(x_n)\right\}_{n=1}^\infty$
approche $1$ lorsque $x_n$ approche $0$.
\[
\begin{array}{l|l|l|l|l|l|l|l|l|l}
n & 1 & 2 & 3 & 4 & \ldots & 100 & \ldots & 10000 & \ldots \\
\hline
\rule[-1em]{0ex}{3em} \DS x_n = \frac{2}{(4n+1)\pi} &
\DS \frac{2}{5\pi} & \DS \frac{2}{9\pi} &
\DS \frac{2}{13\pi} & \DS \frac{2}{17\pi} &
\ldots & \DS \frac{2}{4001\pi} &
\ldots & \DS \frac{2}{40001\pi} & \ldots \\
\hline
...
Donc, dans la définition de $\DS \lim_{x\rightarrow c} f(x) = C$,
il est très important que la suite
$\DS \left\{f(x_n)\right\}_{n=1}^\infty$ tende vers une
{\em valeur unique} $C$ {\em quelle que soit la suite}
$\DS \left\{x_n\right\}_{n=1}^\infty$ qui tend vers $c$.
\end{egg}
...
\lim_{x\rightarrow c} f(x) = C \; ,
\]
où nous utilisons les suites $\DS \left\{x_n\right\}_{n=1}^\infty$
...
$\DS \left\{x_n\right\}_{n=1}^\infty$ qui tendent vers $c$
donnent des suites $\DS \left\{f(x_n)\right\}_{n=1}^\infty$
...
$g(x) = x^2 +1$ satisfait $\DS \lim_{x\rightarrow 1} g(x) = 2$.

Remarquons que toute suite
$\DS \left\{x_n\right\}_{n=1}^\infty$
qui approche $1$ peut s'écrire $x_n = 1 + r_n$ où la suite
$\DS \left\{r_n\right\}_{n=1}^\infty$ approche $0$ lorsque
$n \to \infty$.  C'est certainement le cas pour les
suites $\DS \left\{ 1 + \frac{1}{n} \right\}_{n=1}^\infty$
et $\DS \left\{1+\frac{1}{n^2} \right\}_{n=1}^\infty$
...
$n \to \infty$.  Donc $\DS \lim_{n\rightarrow \infty} g(x_n) = 2$.
\label{egg_contcont1}
\end{egg}
...
en un point que
$\DS \lim_{x\rightarrow 2} \frac{1}{x} = \frac{1}{2}$.
...
\begin{proof}
\subQ{i} Supposons que $\DS \lim_{x\rightarrow c} f(x) = C$
...
$\DS \left|x_\delta -c\right| < \delta$ et
$\DS \left|f(x_\delta) -C\right| \geq \epsilon$.

Si nous prenons $\delta = 1/n$ pour $n$ un entier positif, nous
obtenons une
suite $\DS \left\{ x_{1/n} \right\}_{n=1}^\infty$ telle que
$\DS \left|x_{1/n} - c \right| < \frac{1}{n}$ et
$\DS \left|f(x_{1/n}) -C\right| \geq \epsilon$ pour tout $n$.
Nous avons donc $\DS \lim_{n\rightarrow \infty} x_{1/n} = c$ mais
la suite $\DS \left\{ f(x_{1/n}) \right\}_{n=1}^\infty$ ne
tend pas vers $C$.  Ce qui contredit la définition~\ref{def1_conv}.

\subQ{ii} Supposons maintenant que
$\DS \lim_{x\rightarrow c} f(x) = C$ selon la
définition~\ref{def2_conv}.  Montrons que la
définition~\ref{def1_conv} est satisfaite.

Supposons que $\DS \left\{ x_n \right\}_{n=1}^\infty$ soit
une suite qui tend vers $c$.  Soit $\epsilon >0$.  Selon la
définition~\ref{def2_conv}, il existe $\delta >0$ tel que
$\DS \left|f(x) -C\right| < \epsilon$ si
$\DS \left|x -c\right| < \delta$.  Puisque
$\DS \lim_{n\rightarrow \infty} x_n = c$, il existe $N>0$
tel que $\DS \left|x_n - c \right| < \delta$ pour $n>N$.
Ainsi,
$\DS \left|f(x_n) -C\right| < \epsilon$ pour $n>N$.  Puisque
$\epsilon$ est arbitraire, nous avons
$\DS \lim_{n\rightarrow \infty} f(x_n) = C$.

Comme le résultat du paragraphe précédent est vrai pour toute suite
$\DS \left\{ x_n \right\}_{n=1}^\infty$ qui tend vers $c$,
nous avons que $\DS \lim_{x\rightarrow c} f(x) = C$ selon la
...
$\DS \left\{x_n\right\}_{n=1}^\infty$ qui tend vers $0$,
...
\PDFfig{4_limites/sin_x_x}{$\DS \lim_{x\rightarrow 0}\sin(x)/x = 1$}
{La figure utilisée pour démontrer rigoureusement que
$\DS \lim_{x\rightarrow 0} \sin(x)/x = 1$.}{SINXX}

Comme pour les limites de suites, nous avons les propriétés suivantes.

\begin{theorem} \label{lim_funct_scd}
Supposons que $\DS \lim_{x\rightarrow c} f(x) = A$ et
$\DS \lim_{x\rightarrow c} g(x) = B$.
\begin{enumerate}
\item $\DS \lim_{x\rightarrow c}\; (f(x) + g(x) ) = A + B$.
\item Si $k$ est un nombre réel, alors
$\DS \lim_{x\rightarrow c}\; (k\; f(x)) = kA$.
\item $\DS \lim_{x\rightarrow c}\; (f(x)g(x)) = AB$.
\item Si $B \neq 0$ (donc $g(x) \neq 0$ pour $x$ près de $c$),
alors $\DS \lim_{x\rightarrow c} \frac{f(x)}{g(x)} = \frac{A}{B}$.
\end{enumerate}
\end{theorem}
...
\frac{\DS \lim_{x\rightarrow c} f(x)}
{\DS \lim_{x\rightarrow c} g(x)}
\end{align*}
respectivement.
...
$\DS \lim_{x\rightarrow 1} g(x) = 2$ et $g(1)=2$. 
Donc
\[
\DS \lim_{x\rightarrow 1} g(x) = g(1) \; .
\]
\end{egg}
...
\[
f(x) = \begin{cases}
\DS \frac{\sin(x)}{x} & \qquad \text{pour} \; x\neq 0 \\
...
$\DS f(t) = \frac{0.7 t}{1+t}$ où la variable $t$ est mesurée
...
composition $f\circ g$.   Si $\DS \lim_{x\to r} g(x) = s$
est un élément du domaine de $f$, alors
$\DS \lim_{x\to r} f(g(x)) = f(s)$.  En d'autres mots,
\[
...
\subQ{a} & $\DS \lim_{x\to 2} \sin\left(\frac{x^2-4}{x-2}\right)$ &
\subQ{b} & $\DS \lim_{x\to 4} \frac{x-4}{2 - \sqrt{x}}$ &
\subQ{c} & $\DS \lim_{x\to 1} \frac{x-1}{2 - \sqrt{x+3}}$
\end{tabular}
\end{center}
...
$\DS g(x) = 5 + e^{(2 - x/10)}$ que l'on retrouve à la
...
$\DS g(x) = 5 + e^{(2-x/10)}$}{Le graphe
de $\DS g(x) = 5 + e^{(2-x/10)}$.  Nous avons que $g(x)$
...
$\DS g(x) = 5 + e^{\left(2 - x/10\right)}$.

La suite $\DS \left\{ x_n \right\}_{n=1}^\infty$ où
...
$\DS \left\{ x_n\right\}_{n=1}^\infty$.  Il est clair que
...
$\DS \lim_{x\rightarrow \infty} g(x) = 5$.  Ainsi, $g(x)$
...
que $\DS \lim_{x\rightarrow \infty} g(x) = 5$.  En effet,
puisque $\DS 2- x/10$ devient de plus en plus petit
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.6em}}l@{\hspace*{2.6em}}}l@{\hspace{0.6em}}l}
\subQ{a} & $\DS \lim_{x\to \infty} \frac{x^2 + x  +1}{5x^2 + 1}$ &
\subQ{b} & $\DS \lim_{x\to \infty} \frac{x-4}{x^{3/2} + 2x +1}$ &
\subQ{c} & $\DS \lim_{x\to \infty} \frac{\sqrt{4x^4+5}}
...
= \frac{\DS 1 + \lim_{x\to \infty}(1/x)  + 3\lim_{x\to \infty}(1/x^2)}
{\DS 5 + \lim_{x\to \infty}(1/x^2)}
= \frac{1}{5}
\]
grâce à la proposition~\ref{limite2} qui nous donne
$\DS \lim_{x\to \infty}(1/x) = \lim_{x\to \infty}(1/x^2) = 0$.
...
{1 + (2/x^{1/2}) +(1/x^{3/2})}\\
&= \frac{\DS \lim_{x\to \infty} (1/x^{1/2})
 - 4 \lim_{x\to \infty} (1/x^{3/2})}
{\DS 1 + 2 \lim_{x\to \infty}(1/x^{1/2})
 + \lim_{x\to \infty} (1/x^{3/2})}
= \frac{0}{1} = 0
\end{align*}
grâce encore à la proposition~\ref{limite2} qui nous donne
$\DS \lim_{x\to \infty}(1/x^{1/2}) = \lim_{x\to \infty}(1/x^{3/2}) = 0$.
...
&= \lim_{x\to \infty}
\frac{\sqrt{4 + (5/x^4)}}{\left(1 + (1/x^6) + (1/x^8)\right)^{1/4}}\\
&= \frac{\sqrt{\DS 4 + \lim_{x\to \infty} (5/x^4)}}
{\left(\DS 1 + \lim_{x\to \infty} (1/x^6)
+ \lim_{x\to \infty} (1/x^8)\right)^{1/4}}
= \frac{\sqrt{4}}{1^{1/4}} = 2
\end{align*}
car $\DS \lim_{x\to \infty}(1/x^r) = 0$ pour $r>0$ comme nous
...
\]
si la suite $\DS \left\{ f(x_n) \right\}_{n=1}^\infty$
...
\begin{egg}
Si $\DS f(x) = \frac{2}{(x-3)^2}$, que se passe-t-il lorsque
...
$\DS \left\{x_n\right\}_{n=1}^\infty$ qui tend vers $3$, la
suite
$\DS \left\{\frac{2}{(x_n-3)^2}\right\}_{n=1}^\infty$
...
\begin{egg}
Si $\DS f(x) = \frac{2}{x^2-9}$, que se passe-t-il lorsque
$x$ approche $3$?  Remarquons que $f(x)$ n'est pas définie pour
$x=3$.
...
\]
{\em quelle que soit la suite}
$\DS \left\{x_n\right\}_{n=1}^\infty$ avec {\em $x_n >c$}
qui tend vers $c$.
Nous disons que {\bfseries $f(x)$ converge (ou tend) vers plus l'infini
...
$\DS \lim_{x\rightarrow c^-} f(x) = \infty$
alors que dans le graphe à de droite 
$\DS \lim_{x\rightarrow c^+} f(x) = -\infty$.}{LIM_INFINI}
...
\begin{egg}
Revenons à $\DS f(x) = \frac{2}{x^2-9}$ que nous avons étudié
...
$\DS \frac{2}{x^2-9} > M$; c'est-à-dire, telles que
...
$3$ telles que $\DS \frac{2}{x^2-9} < M$; c'est-à-dire,
...
$\DS M = \frac{1}{4\epsilon^2}$, nous obtenons
\[
...
$\DS \lim_{x\rightarrow +\infty} g(x) = 5$ 
où $\DS g(x)= 5 + e^{2-x/10}$.  Si nous posons $f(x) = 5$ pour
tout $x$, alors
\[
\lim_{x\rightarrow +\infty} \frac{f(x)}{g(x)} = 1 \; .
\]
...
$\DS \lim_{t\rightarrow 1^-} p(t)$,
$\DS \lim_{t\rightarrow 1^+} p(t)$ et
$\DS \lim_{t\rightarrow 1} p(t)$ si cela est possible.
\label{4Q2}
\end{question}
...
\subQ{a} & $\DS \lim_{x\rightarrow 0} \frac{1-\cos(x)}{x}$ &
\subQ{b} & $\DS \lim_{x\rightarrow 0} \frac{\ln(1-x)}{x}$
\end{tabular}
\end{center}
\label{4Q3}
\end{question}
...
\begin{question}
Nous savons que $\DS \lim_{x\rightarrow 0^+} \sqrt{x} = 0$.
...
$\DS \lim_{t\rightarrow 0} v(t)$.  Soit $\alpha$ la valeur de cette
limite.
\begin{enumerate}
...
Évaluez si possible la limite $\DS \lim_{x\to 0} x^2\sin(1/x)$.
\label{4Q7}
\end{question}
...
\end{cases} \ .
\]
Est-ce que $\DS \lim_{x\to 0} H(x) = 1$?  Justifiez votre
réponse.
\label{4Q8}
\end{question}
...
\subQ{a} & $\DS \lim_{t\rightarrow 0} \frac{1+t+t^2}{1+t}$ &
\subQ{b} & $\DS \lim_{x\rightarrow 0} \frac{e^x}{1+x}$ &
\subQ{c} & $\DS \lim_{x\to 2} \frac{(x-2)}{2+\sqrt{2x^2-4}}$ \\[0.9em]
\subQ{d} & $\DS \lim_{z\rightarrow 0} \frac{3z}{1+\ln(1+z)}$ &
\subQ{e} & $\DS \lim_{x\to 3} \frac{\cos(\pi/x)}{x^2-5}$ & &
\end{tabular}
\end{center}
\label{4Q9}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \lim_{x\to 3} \frac{(x-3)}{2-\sqrt{x^2-5}}$ &
\subQ{b} & $\DS \lim_{x\to 5} \frac{|x-5|}{x^2-25}$ &
\subQ{c} & $\DS \lim_{x\rightarrow 0}
    \frac{3-\sqrt{9-3x}}{8x}$ \\[0.9em]
\subQ{d} & $\DS \lim_{x\to 1} \frac{|x-2|-1}{x^2-1}$ &
\subQ{e} & $\DS \lim_{x\to -3} \frac{|x+3|(5+x)}{x+3}$ &
\subQ{f} & $\DS \lim_{x\to 1} \frac{5x^4 + 3x^2-8}{12x^2-11x-1}$
\end{tabular}
\end{center}
\label{4Q10}
\end{question}
...
f(x) =
\begin{cases}
\DS a \sin\left(\frac{\pi x}{2}\right) &
\quad \text{si} \quad x < 3 \\
\DS \frac{x^2}{2} - 4 & \quad \text{si} \quad x \geq 3
\end{cases}
\]
...
\[
f(x) = \begin{cases}
\DS \frac{x^2 - 2 x- 3}{x-3} & \quad \text{si} \quad x<3 \\
a x^2 + x + b & \quad \text{si}\quad  3 \leq x < 4 \\
\DS b \sqrt{x} + \frac{5 a x}{2} &  \quad \text{si}\quad x \geq 4
\end{cases}
\]
...
\subQ{b} & $\DS e^{\cos(x/2)}=2\sin(x/2)$ sur $[0,\pi]$
\end{tabular}
\end{center}
\label{4Q18}
\end{question}
...
\begin{question}
Nous savons que
$\DS \lim_{x\rightarrow 0^+} \frac{1}{\sqrt{x}} = +\infty$.
Pour quelles valeurs de $x$ aurons-nous que
$\DS \frac{1}{\sqrt{x}} >10$? Que 
$\DS \frac{1}{\sqrt{x}} >100$?  Est-ce que
$\DS \frac{1}{\sqrt{x}}$ croît rapidement ou lentement
lorsque $x>0$ approche $0$?
\label{4Q21}
\end{question}
...
\subQ{a} &
$\DS \lim_{x\rightarrow \infty} \frac{x^2+5x-4}{3x^2 +1}$ &
\subQ{b} &
$\DS \lim_{x\rightarrow \infty} \frac{x-(8x^3+3)^{1/3}}{x}$ &
\subQ{c} & $\DS \lim_{x\rightarrow 0}\; \frac{1}{x}$ \\[1em]
\subQ{d} &
$\DS \lim_{x\rightarrow \infty} \left(\sqrt{x^2+3x}
- \sqrt{x^2 + 7x}\right)$ &
\subQ{e} &
$\DS \lim_{x\rightarrow \infty} \frac{2e^{2x} -e^{-3x}}
{3e^{2x} - 4e^{-5x}}$ & &
\end{tabular}
\end{center}
\label{4Q24}
...
$\DS \lim_{x\to \infty} \frac{\sin^2(x)}{1+x^2}$.
\label{4Q25}
\end{question}
