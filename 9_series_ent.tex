...
\]
où $\DS \left\{a_n\right\}_{n=0}^\infty$ est une suite de
...
$\DS \sum_{n=0}^k a_n (x-c)^n$ est une {\bfseries somme partielle}
de la série. \index{Série entière!somme partielle}

le contexte détermine si $\DS \sum_{n=0}^\infty a_n (x-c)^n$ fait
...
\begin{egg}
La série entière $\DS \sum_{n=0}^\infty \frac{x^n}{n!}$ converge
absolument pour tout $x$.

Les termes de cette série sont $\DS a_n = \frac{x^n}{n!}$.
Ainsi,
\[
...
$\DS \sum_{i=0}^\infty \frac{(-5)^n(x-2)^n}{n^2+1}$ converge
absolument pour $9/5 < x < 11/5$.

Les termes de la série sont de la forme
$\DS a_n = \frac{(-5)^n(x-2)^n}{n^2+1}$.
Ainsi,
\begin{align*}
\lim_{n\rightarrow \infty} \frac{|a_{n+1}|}{|a_n|}
...
\begin{theorem}
Soit $\DS \left\{a_n\right\}_{n=0}^\infty$ une suite de nombres
réels et $c$ un nombre réelle.  Soit que la séries entière
$\DS \sum_{n=0}^\infty a_n (x-c)^n$ diverge pour toute valeur
de $x \neq c$ ou il existe un nombre $R>0$ ($R=\infty$ est admissible)
tel que la série entière $\DS \sum_{n=0}^\infty a_n (x-c)^n$
...
$\DS \sum_{n=0}^\infty a_n (x-c)^n$ pour $|x-c|=R$.  Il
...
de $\DS \sum_{n=0}^\infty a_n (x-c)^n$ pour ces valeurs de $x$.
\end{rmk}

\begin{egg}[][Suite de l'exemple~\ref{entiere_egg}] \label{entiere_eggS}
Nous avons montré que la série
$\DS \sum_{i=0}^\infty \frac{(-5)^n(x-2)^n}{n^2+1}$ convergeait
...
$\DS \frac{1}{n^2+1} < \frac{1}{n^2}$ et la série
$\DS \sum_{i=1}^\infty \frac{1}{n^2}$ converge d'après la
...
$\DS \sum_{i=0}^\infty (-1)^n a_n$ avec $a_n = 1/(n^2+1)$.  Nous avons
$a_n>0$ et $a_{n+1} < a_n$ pour tout $n$.  De plus
$\DS \lim_{n\rightarrow \infty} a_n = 0$.
\end{egg}

\begin{defn}
Le {\bfseries rayon de convergence} d'une série entière
$\DS \sum_{n=0}^\infty a_n (x-c)^n$ est le nombre $R$ tel que la
...
$\DS \left\{x : \sum_{n=0}^\infty a_n (x-c)^n
\text{ converge} \right\}$.
...
$\DS \sum_{i=0}^\infty \frac{(-5)^n(x-2)^n}{n^2+1}$ est
$1/5$ et l'intervalle de convergence est
$\DS \left[\frac{9}{5} , \frac{11}{5}\right]$.
\end{egg}
...
$\DS \sum_{n=0}^\infty a_n (x-c)^n$ est donnée par
\[
...
C'est une série de la forme $\DS \sum_{n=1}^\infty a_n x^n$ où
\[
...
\frac{\DS \frac{2 \times 4 \times \ldots \times (2n+2)}
{\DS 1 \times 3 \times \ldots \times (2n+1)}}
{\DS \frac{2 \times 4 \times \ldots \times (2n)}
{\DS 1 \times 3 \times \ldots \times (2n-1)}} \right|
...
{1 \times 3 \times \ldots \times (2n-1)} \; .
\end{equation}
C'est une série de la forme $\DS \sum_{n=1}^\infty a_n$ où
\[
a_n = \frac{2\times 4 \times \ldots \times (2n)}
{1 \times 3 \times \ldots \times (2n-1)}
...
$\DS \left\{ a_n \right\}_{n=1}^\infty$ des termes de la
...
Considérons la série entière $\DS \sum_{n=0}^\infty a_n (x-c)^n$
...
\]
Puisque $\DS F(x) = \int_c^x f(t) \dx{t}$ est une primitive
...
$\DS \dydxn{f}{x}{n}(0) = 0$ pour tout $n>0$.
Donc
\[
...
\]
pour $\DS f(x) = \frac{1}{1-x}$.  Puisque
\[
f^{(n)}(x) = \frac{n!}{(1-x)^{n+1}} \quad \text{pour} \quad n=0, 1, 2,
\ldots
\]
nous avons que $\DS f^{(n)}(0) = n!$ pour $n=0$, $1$, $2$,
\ldots\quad  Donc
\[
...
\]
où $\DS g(t) = \frac{(x-t)^k}{k!}$ et $h'(t) = f^{(k+1)}(t)$.
Donc $\DS g'(t) = -\frac{(x-t)^{k-1}}{(k-1)!}$, 
$h(t) = f^{(k)}(t)$ et
\begin{align}
...
= \int_c^x g(t)h'(t) \dx{t}
\]
où $\DS g(t) = \frac{(x-t)^{k-1}}{(k-1)!}$ et
$h'(t) = f^{(k)}(t)$.  Donc
$\DS g'(t) = -\frac{(x-t)^{k-2}}{(k-2)!}$, 
$h(t) = f^{(k-1)}(t)$ et
\begin{align*}
\int_c^x \frac{(x-t)^{k-1}}{(k-1)!} f^{(k)}(t) \dx{t}
...
\]
Puisque $\DS \int_c^x f'(t)\dx{t} = f(x)-f(c)$, nous obtenons
finalement
\begin{align*}
...
$\DS f(x) = \frac{1}{1-x}$ est la série géométrique
$\DS \sum_{n=0}^\infty x^n$.  À l'exemple~\ref{geoseries}, 
...
$\DS \lim_{k\rightarrow \infty} r_k(x) = 0$ pour tout $x$.
...
\]
pour tout $x$.  Puisque $\DS \left| g^{(k+1)}(\xi) \right|
= \left| (-1)^{(k+1)/2} \sin(\xi) \right| \leq 1$ pour $k$ impaire et
$\DS \left| g^{(k+1)}(\xi) \right|
...
$\DS \sum_{n=0}^\infty \frac{x^n}{n!}$ convergeait pour
tout $x$.  Il découle du théorème~\ref{NCforCofS} que le terme général
$\DS \frac{x^n}{n!}$ de la série tend vers $0$ pour tout $x$
...
\begin{egg}
Si $\DS f(x) = \frac{1}{(x-1)(1-2x)}$, quelle est la valeur
de $f^{(100)}(0)$?
...
\begin{egg}
Évaluons l'intégrale $\DS \int_0^{0.5} \cos(x^2) \dx{x}$ avec une
précision de $10^{-8}$.
...
$\DS \sum_{n=0}^\infty (-1)^n a_n$ où
$\DS a_n = \frac{1}{2^{4n+1}\,(4n+1)\,(2n)!}$.  Notez que cette
...
$\DS S = \sum_{n=0}^\infty (-1)^n a_n$ et
$\DS S_N = \sum_{n=0}^N (-1)^n a_n$ est la $N^{e}$ somme
partiel, alors $\DS |S-S_N| \leq a_{N+1}$.

La somme partiel $S_N$ donnera une approximation de
$\DS \int_0^{0.5} \cos(x^2) \dx{x}$ avec
une précision de $10^{-8}$ si nous choisissons $N$ tel que
$\DS |S-S_N| \leq a_{N+1} < 10^{-8}$.
Nous avons
\[
...
\end{equation}
Pour cette raison, $\DS \binom{k}{n}$ est appelé un
...
\begin{proof}[Démonstration (Théorème~\ref{bin_series}) \theory]
...
$\DS \sum_{n=0}^\infty a_n x^n$ où
$\DS a_n = \binom{k}{n}$.  Donc 
\[
\frac{1}{R} = \lim_{n\rightarrow \infty} \left|\frac{a_{n+1}}{a_n}\right|
= \lim_{n\rightarrow \infty} \left|
\frac{\DS \frac{k(k-1)(k-2)\ldots(k-n)}{(n+1)!}}
{\DS \frac{k(k-1)(k-2)\ldots(k-n+1)}{n!}} \right|
...
\item $\DS \dydx{E}{x}(x) = E(x)$ pour tout $x$.
\end{enumerate}
\end{prop}
...
De plus, puisque $\DS b^{1/\ln(b)} = e$ car
\[
...
\subQ{a} & $\DS \sum_{n=1}^\infty \frac{x^n}{n^2}$ &
\subQ{b} & $\DS \sum_{n=0}^\infty \frac{n^2 x^n}{10^n}$ &
\subQ{c} & $\DS \sum_{n=0}^\infty \frac{x^n}{n!}$ \\[1em]
\subQ{d} & $\DS \sum_{n=0}^\infty \sqrt{n}(x+2)^n$ &
\subQ{e} & $\DS \sum_{n=1}^\infty (-1)^n \,\frac{(x-1)^n}{n\,4^n}$ &
\subQ{f} & $\DS \sum_{n=1}^\infty
\frac{n x^n}{ 1 \cdot 3 \cdot 5 \cdot \ldots \cdot (2n-1)}$  \\[1em]
\subQ{g} & $\DS \sum_{n=0}^\infty (-1)^n \frac{(5x-1)^n}{\sqrt{n+1}}$
&
\subQ{h} & $\DS   \sum_{n=1}^\infty\;(-1)^n\frac{(5x-1)^n}{3^n\,n^2}$
&
\subQ{i} & $\DS \sum_{n=1}^\infty \frac{(-5)^n (x+3)^n}{n}$  \\[1em]
\subQ{j} & $\DS \sum_{n=1}^\infty \frac{3^n(x-2)^n}{n^2}$ &
\subQ{k} & $\DS \sum_{n=1}^\infty \frac{(x-2)^n}{3^n\sqrt{n}}$ &
&
\end{tabular}
\end{center}
\label{9Q1}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \sum_{n=1}^\infty \frac{(-1)^n x^{2n-1}}{(2n-1)!}$ &
\subQ{b} & $\DS \sum_{n=0}^\infty (-1)^n \,\frac{x^{2n+1}}{2n+1}$ &
\subQ{c} & $\DS \sum_{n=1}^\infty\frac{4^nx^{2n}}{n^2}$
\end{tabular}
\end{center}
...
\subQ{a} & $\DS \sum_{n=0}^\infty x^{n+1}$ &
\subQ{b} & $\DS \sum_{n=1}^\infty x^{2n}$
\end{tabular}
\end{center}
\label{9Q3}
\end{question}
...
$\DS \sum_{n=1}^\infty n 2^{n-1} x^{n+1}$ sur son intervalle de
...
$\DS \int_0^2 g(x) \dx{x}$ si cela est possible.  Justifiez
si c'est possible.
\label{9Q5}
\end{question}

\begin{question}
Donnez la série entière de la fonction $\DS f(x) = \ln (1 + x^2)$
...
calculer $\DS \dydxn{f}{x}{9}(0)$.
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{4em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS f(x) = e^{x^3}$ &
\subQ{b} & $\DS f(x) = x^3\,e^{x^2}$ &
\subQ{c} & $\DS f(x) = \frac{x}{4+x^2}$
\end{tabular}
\end{center}
\label{9Q7}
\end{question}
...
$\DS f(x) = \frac{x^2}{1+x^2}$ et
$\DS \int f(x)\dx{x}$.  Pour chaque série, donnez
...
\[
\DS \int_0^{0.5} x^2 \arctan(x^2) \dx{x}
\]
...
$\DS f(x) = \frac{x}{(x^2-4)^2}$ pour $|x| <2$..
\label{9Q12}
\end{question}
...
\subQ{a} & $\DS \frac{1}{1+x}$ &
\subQ{b} & $\DS (1+x)^{1/8}$ &
\subQ{c} & $\DS \sqrt{1+\frac{x}{2}}$ &
\subQ{d} & $\DS \frac{1}{\sqrt{1+x}}$
\end{tabular}
\end{center}
...
\begin{question}
Si $\DS (1+x^3)^{3/5} = \sum_{n=0}^\infty b_n x^n$, quelle
