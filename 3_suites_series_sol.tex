\nonumsection{Chapter~\ref{ChapSuitesSeries} : Suites et séries}

\nonumsubsection{Suites}
...
\subQ{b} Puisque
$\DS \ln(n+3) - \ln(n) = \ln\left(\frac{n+3}{n}\right)
...
$\DS \frac{3}{2}+\frac{6}{5} = \frac{27}{10}$.
...
\]
De plus, $\DS \sum_{n=0}^\infty \left(\frac{2}{5}\right)^n$ et
$\DS \sum_{n=0}^\infty \left(\frac{3}{5}\right)^n$ sont deux
séries géométriques convergentes.  La première séries est de raison
$\DS r= \frac{2}{5}$ et converge vers
$\DS \frac{1}{1-2/5} = \frac{5}{3}$.
La seconde série est de raison $\DS r= \frac{3}{5}$ et
converge vers $\DS \frac{1}{1-3/5} = \frac{5}{2}$.  Nous avons
donc que
\[
...
= 30 - \frac{30}{N+2} \ .
\end{align*}
Puisque $\DS \lim_{N\to \infty}\frac{30}{N+2} = 0$, nous
obtenons
\[
...
\end{align*}
Puisque $\DS \lim_{N\to \infty}\frac{1}{5(N+1)} = 0$, nous
obtenons
\[
...
\nonumsubsection{Tests de convergence}
...
= e^2 \neq 0 \ ,
\]
la série $\DS \sum_{n=1}^\infty \left(1+\frac{2}{n}\right)^n$
diverge.

\subQ{f} Nous utilisons le test du quotient avec
$\DS a_n = \frac{(n+1)^2}{n!}$.  Puisque
\begin{align*}
...
$\DS \sum_{n=1}^\infty \frac{1}{n^2}$ qui converge car c'est
une série de la forme
$\DS \sum_{n=1}^\infty \frac{1}{n^p}$ avec $p>1$
...
$\DS \sum_{n=1}^\infty \frac{1}{n(n^3+5)^{1/3}}$ converge
...
convergente $\DS \sum_{n=1}^\infty \frac{1}{n^2}$ pour
...
\subQ{i} Nous avons la séries $\DS \sum_{n=1}^\infty a_n$ avec
$\DS a_n = \frac{n}{5^n}$.  Puisque
\[
...
$\DS \frac{1}{3n^3} > \frac{1}{3n^3 + n +4}$ pour tout
$n>0$.  Ainsi
\[
0 < \frac{5+3\sin(n)}{3n^3+n+4} \leq \frac{8}{3n^3}  \ .
\]
Or la série
$\DS \sum_{n=1}^\infty \frac{8}{3n^3} = 
...
$\DS \sum_{n=1}^\infty \frac{5+3\sin(n)}{3n^3+n+4}$
converge.
}

\nonumsubsection{Convergence absolue et séries alternées}

\compileSOL{\SOLUb}{\ref{3Q7}}{
\subQ{b} La séries
$\DS \sum_{n=2}^\infty \frac{(-1)^n}{\ln(n)}$
est une série alternée de la forme
$\DS \sum_{n=2}^\infty (-1)^na_n$
avec $\DS a_n = \frac{1}{\ln(n)}$.
Nous avons $a_n >0$ et $a_{n+1} < a_n$ pour tout $n$, et
$\DS \lim_{n\to \infty} a_n = 0$.  Donc, grâce au
théorème~\ref{altTest}, la série converge.

Par contre, $\DS \frac{1}{\ln(n)} > \frac{1}{n}$ pour tout
$n > 1$ et $\DS \sum_{n=2}^\infty \frac{1}{n}$ diverge (la série
harmonique).  Donc, par le test de comparaison,
$\DS \sum_{n=2}^\infty \frac{1}{\ln(n)}$ diverge.

En conclusion, $\DS \sum_{n=2}^\infty \frac{(-1)^n}{\ln(n)}$
converge seulement conditionnellement.

\subQ{c} Nous pouvons montrer à l'aide du Test de d'Alembert que
$\DS \sum_{n=1}^\infty \frac{(-1)^n n!}{(2n+1)!}$
converge absolument.  En effet, avec
$\DS a_n = \frac{(-1)^n n!}{(2n+1)!}$,
\[
...
\subQ{d} La séries
$\DS \sum_{n=1}^\infty \frac{(-1)^n}{\sqrt{n(n+2)}}$
est une série alternée de la forme
$\DS \sum_{n=2}^\infty (-1)^na_n$ avec
$\DS a_n = \frac{1}{\sqrt{n(n+2)}}$.
...
\]
et $\DS \sum_{n=2}^\infty \frac{1}{n}$ diverge (série
harmonique).  Donc, par le test de comparaison à la limite, \\
$\DS \sum_{n=2}^\infty \frac{1}{\sqrt{n(n+2)}}$ diverge.

En conclusion, $\DS \sum_{n=2}^\infty \frac{(-1)^n}{\sqrt{n(n+2)}}$
converge seulement conditionnellement.

\subQ{e} Puisque $\DS \sum_{n=1}^\infty \frac{1}{n^{3/2}}$ et 
$\DS \sum_{n=1}^\infty \frac{1}{n^2}$ converge
(proposition~\ref{Pseries} avec $p=3/2$ et $p=2$ respectivement), nous avons
que
$\DS \sum_{n=1}^\infty \left(\frac{1}{n^{3/2}} + \frac{1}{n^2}\right)$
converge (théorème~\ref{series_linear}).  Donc\\
$\DS \sum_{n=1}^\infty (-1)^n\left(\frac{1}{n^{3/2}}
  + \frac{1}{n^2}\right)$ converge absolument.

\subQ{f} la suite
$\DS \sum_{n=1}^\infty (-1)^n \frac{n^2}{(2n+1)(2n+3)}$
ne converge pas absolument car \\
$\DS \lim_{n\rightarrow \infty} \frac{n^2}{(2n+1)(2n+3)} = 1/4 \neq 0$.
Elle ne converge même pas simplement car \\
$\DS \left\{(-1)^n \frac{n^2}{(2n+1)(2n+3)}\right\}_1^\infty$
ne converge pas vers $0$.
}

\compileSOL{\SOLUb}{\ref{3Q8}}{
Nous avons une série alternée
$\DS \sum_{n=1}^\infty (-1)^{n+1} a_n$
avec $\DS a_n = \frac{1}{3^n}$.  Vérifions les conditions du
test des séries alternées.  Nous avons $a_n>0$ sans aucun doute.  De plus
$\DS \lim_{n\to \infty} a_n = 0$ grâce à la 
proposition~\ref{suite1}.  Finalement,
$\DS a_n = \frac{1}{3^n} > \frac{1}{3^{n+1}} = a_{n+1}$. 
Donc la série alternée
$\DS \sum_{n=1}^\infty \frac{(-1)^{n+1}}{3^n}$ converge.
...
Nous avons une série alternée $\DS \sum_{n=1}^\infty (-1)^n a_n$
...
$\DS \sum_{n=1}^\infty \frac{(-1)^n \, n}{4^n}$ converge.
