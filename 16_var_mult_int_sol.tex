\nonumsection{Chapter~\ref{chapIntMult} : Intégrales multiples}

\nonumsubsection{Théorème de Fubini}
...
L'intersection du plan $\DS 2x+y+ \frac{z}{3}=1$ avec le plan $z=0$
est la droite $\DS 2x+y =1$.
...
L'intersection du plan $\DS 3x+ 3y+ 2z=6$ avec le plan $z=0$
est la droite $\DS y=-x+2$.
Ainsi,
\begin{align*}
\int_S xy \dx{V} &
...
$\DS \frac{16}{9} z^2 = x^2 + y^2$ pour $z\geq 0$.
