...
$\DS \int f(x) \dx{x}$.  Si $F$ est une primitive de
$f$, alors
\[ 
\int f(x)  \dx{x} = F(x) + C
\]
...
\[
\begin{array}{c|c|cl}
f(x) & \DS \int f(x)\dx{x} & \text{contraintes} \\
\hline
...
\subQ{a} & $\DS \int e^{5x} \dx{x}$  &
\subQ{b} & $\DS \int x\sin(x^2) \dx{x}$ &
\subQ{c} & $\DS \int \frac{x^3}{\sqrt{x^2+5}} \dx{x}$
\end{tabular}
\end{center}
...
\subQ{a} & $\DS \int \frac{\cos^3(x)}{\sqrt{\sin(x)}} \dx{x}$ &
\subQ{b} & $\DS \int \frac{1}{1+x^{1/3}} \dx{x}$ \\[1em]
\subQ{c} & $\DS \int \frac{x}{\sqrt{16 - 9x^4}} \dx{x}$ &
\subQ{d} & $\DS \int \frac{1}{x^2+2x+10} \dx{x}$
\end{tabular}
\end{center}
...
\]
Si $\DS y = \frac{3x^2}{4}$, alors
$\DS \dx{y} = \frac{3x}{2} \dx{x}$ et
\begin{align*}
\int \frac{x}{\sqrt{16 - 9x^4}} \dx{x} &= 
...
\]
Pour ce faire, posons $\DS y = \frac{x+1}{3}$.  Ainsi,
$\DS \dx{y} = \frac{1}{3} \dx{x}$ et
\begin{align*}
...
$\DS \int \frac{\sqrt{x}}{\sqrt{x} - \sqrt[3]{x}} \dx{x}$.
...
\subQ{a} & $\DS \int \tan(x) \dx{x}$ &
\subQ{b} & $\DS \int \sin^2(x)\dx{x}$ &
\subQ{c} & $\DS \int \sin^3(x)\dx{x}$ \\[1em]
\subQ{d} & $\DS \int \sin^3(x)\cos^2(x) \dx{x}$ &
\subQ{e} & $\DS \int \sec(x) \dx{x}$ &
\subQ{f} & $\DS \int \csc(x) \dx{x}$
\end{tabular}
\end{center}
...
\subQ{a} & $\DS \int \sin(4x)\cos(3x) \dx{x}$ &
\subQ{b} &
$\DS \int \sin\left(x+\frac{\pi}{6}\right)\cos(x) \dx{x}$ 
\end{tabular}
\end{center}
...
évaluer l'intégrale\\ $\DS \int \sin(x) \cos(x) \dx{x}$
...
\begin{egg}
Évaluons l'intégrale indéfinie $\DS \int x e^x\dx{x}$.
...
\subQ{a} & $\DS \int x^2 \cos(2x)\dx{x}$ &
\subQ{b} & $\DS \int \sqrt{t} \ln(t) \dx{t}$ \\[1em]
\subQ{c} & $\DS \int x^3 \ln(2x)\dx{x}$ &
\subQ{d} & $\DS \int \ln(x)\dx{x}$
\end{tabular}
\end{center}
...
$g'(t)= t^{1/2}$.  Donc $\DS f'(t) = \frac{1}{t}$,
$\DS g(t) = \frac{2}{3} t^{3/2}$ et
\begin{align*}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{2.5em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int x\,5^x \dx{x}$ &
\subQ{b} & $\DS \int \arcsin(x) \dx{x}$ &
\subQ{c} & $\DS \int \arctan(x) \dx{x}$
\end{tabular}
\end{center}
...
\end{align*}
Il ne faut pas oublier que $\DS \dfdx{5^x}{x} = 5^x \ln(5)$.

\subQ{b} Nous avons $\arcsin(x) = f(x) g'(x)$ pour $f(x)=\arcsin(x)$ et
$g'(x) = 1$. Donc $g(x) = x$,
$\DS f'(x) = \frac{1}{\sqrt{1-x^2}}$ et
\begin{align*}
...
$g'(x) = 1$. Donc $g(x) = x$, $\DS f'(x) = \frac{1}{1+x^2}$
et
\begin{align*}
...
\begin{egg}
Évaluons l'intégrale indéfinie $\DS \int e^{\sqrt{x}} \dx{x}$.
...
\subQ{a} & $\DS \int e^x\cos(x) \dx{x}$ &
\subQ{b} & $\DS \int \sin(\ln(x)) \dx{x}$ \quad , \quad $x>0$
\end{tabular}
\end{center}
...
\]
si $t\neq \pm 1$.  Donc $\DS \sec(x) = \frac{1+t^2}{1-t^2}$
donne
...
$\DS y= \frac{2}{\sqrt{3}}\left(t+\frac{1}{2}\right)$, nous
obtenons
$\DS \dx{y}= \frac{2}{\sqrt{3}} \dx{t}$ et
\begin{align*}
\int \frac{1}{2+\sin(x)} \dx{x} &=
\frac{2}{\sqrt{3}}
...
\; .
\end{align*}
Finalement, puisque $\DS t = \tan\left(\frac{x}{2}\right)$, nous
trouvons
\[
\int \frac{1}{2+\sin(x)} \dx{x}
= \frac{2}{\sqrt{3}}
...
\begin{egg}
Évaluons l'intégrale indéfinie
$\DS \int \frac{x^4+x^3-x^2-x+1}{x^3-x} \dx{x}$.
...
\]
Si $\DS y=\frac{x+3}{\sqrt{3}}$, alors
$\DS \dx{y} = \frac{1}{\sqrt{3}} \, \dx{x}$ et
\begin{align*}
\frac{1}{3} \int \frac{1}{ \left((x+3)/\sqrt{3}\right)^2 + 1} \dx{x}
...
\begin{egg}[\eng]
Évaluons l'intégrale indéfinie 
$\DS \int \frac{4x+1}{(x-3)(x^2+6x+12)}  \dx{x}$.
...
\begin{egg}[\eng]
Évaluons l'intégrale indéfinie
$\DS \int \frac{1}{3\sin(x)+\cos(x)} \dx{x}$.
...
\begin{egg}
Évaluons l'intégrale indéfinie
$\DS \int \frac{1}{x^2\sqrt{1-x^2}} \dx{x}$ pour
$-1 < x < 1$.
...
\begin{egg}
Évaluons l'intégrale indéfinie
$\DS \int \sqrt{x^2+1} \dx{x}$ pour $x \in \RR$.
...
nous avons $\DS \sec(t) = \sqrt{1+\tan^2(t)} = \sqrt{1+x^2}$.
Ainsi,
\[
...
\begin{egg}
Évaluons l'intégrale indéfinie
$\DS \int \left(\frac{x-1}{x}\right)^{1/2} \dx{x}$
pour $x>1$.
...
$\DS \sqrt{y^2-1} = \sqrt{\sec^2(\theta)-1} = \tan(\theta)$ 
...
\begin{egg}
Évaluons l'intégrale indéfinie 
$\DS \int \frac{\sqrt{x^2-1}}{x^3}  \dx{x}$ pour
$x>1$.
...
\begin{egg}
Évaluons l'intégrale indéfinie
$\DS \int \frac{1}{(4x^2-25)^{3/2}} \dx{x}$
pour $x>5/2$.
...
\]
Si $\DS x = \frac{5}{2} \sec(t)$ pour
$0 < t < \pi/2$, alors
$\DS \dx{x} = \frac{5}{2} \tan(t)\sec(t) \dx{t}$ et
\begin{align*}
\frac{1}{8} \, \int \frac{1}
{\left(x^2 - \left(\frac{5}{2}\right)^2\right)^{3/2}} \dx{x}
...
\sqrt{\tan^2{x}} = \tan{x} > 0
\]
pour $0< t < \pi/2$.  Puisque $\DS \sec(t) = \frac{2}{5}\, x$ donne
$\DS \cos(t) = \frac{5}{2x}$, nous obtenons
\[
\sin(t) = \sqrt{1-\cos^2(t)} = \sqrt{1 -\left(\frac{5}{2x}\right)^2}
= \frac{\sqrt{4x^2-25}}{2x}
\]
car $\DS x = \frac{5}{2}\sec(t) > \frac{5}{2} $ et
...
Comme le symbole de sommation $\DS \sum$ sera très utile, il
...
\]
Nous écrivons $\DS \DS \int_a^b f(x) \dx{x} = I$.
...
estimer la valeur de l'intégrale $\DS \int_a^b f(x) \dx{x}$
...
\begin{egg}
Estimons $\DS \int_{-1}^2  (1 + x^2) \dx{x}$.  Pour ce faire, nous
...
= 5.9375 \ .
\]
Donc $\DS \int_{-1}^2 (1+x^2) \dx{x} \approx S_6 = 5.9375$.
...
$\DS \int_{x_i}^{x_{i+1}} f(x) \dx{x}$ que la somme à droite.
...
$\DS \int_{x_i}^{x_{i+1}} f(x) \dx{x}$ que la somme à gauche.
...
$\DS \int_{x_i}^{x_{i+1}} f(x) \dx{x}$.  La somme pour
...
$\DS \int_0^1 x^3 \dx{x}$.
En effet, soit $\DS \Delta x = \frac{1}{n}$ et
$\DS x_i = i \Delta x = \frac{i}{n}$ pour $i=0$, $1$, $2$,
...
\]
est une somme de Riemann à droite pour l'intégrale
$\DS \int_2^4 \frac{x^2}{2} \dx{x}$.
En effet, soit $\DS \Delta x = \frac{2}{n}$ et
$\DS x_i = 2 + i \Delta x = 2 + \frac{2i}{n}$ pour
$i=0$, $1$, $2$, \ldots, $n$.  Nous obtenons la somme à droite suivante
pour $\DS \int_2^4 \frac{x^2}{2} \dx{x}$.
\[
...
\]
Puisque $\DS \int_0^4 f'(x) \dx{x}$ représente la moitié de
...
\begin{tabular}{*{1}{l@{\hspace{1em}}l@{\hspace{5em}}}l@{\hspace{1em}}l}
\subQ{a} &
$\DS \int_4^9 \left(\sqrt{t} + \frac{1}{\sqrt{t}}\right)^2 \dx{t}$ &
\subQ{b} & $\DS \int_0^{1/2} \frac{1}{\sqrt{1-x^2}} \dx{x}$
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{2.5em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_1^3 \frac{x^2}{\sqrt{x^3+5}} \dx{x}$  &
\subQ{b} & $\DS \int_0^{\pi/2} e^{-\cos(\theta)} \sin(\theta)
\dx{\theta}$ &
\subQ{c} & $\DS \int_0^{1/\sqrt{2}} \frac{x}{\sqrt{1-x^4}} \dx{x}$
\\[1em]
\subQ{d} & $\DS \int_0^{\pi^2} \frac{\cos(\sqrt{x})}{\sqrt{x}}
\dx{x}$ &
\subQ{e} & $\DS \int_0^4 \frac{t+7}{\sqrt{5-t}} \dx{t}$
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{1em}}l@{\hspace{5em}}}l@{\hspace{1em}}l}
\subQ{a} & $\DS \int_1^3 (5x+2)e^{3x} \dx{x}$ &
\subQ{b} & $\DS \int_0^1 \arctan(t) \dx{t}$
\end{tabular}
\end{center}
...
$\DS F(x) = \int_1^{x^2} (1+s^2)^{3/2} \dx{s}$.
...
$\DS F(x) = \int_0^x f(s)\dx{s}$}{sndFTC}
...
$\DS \int_{-\infty}^{-1} \frac{1}{(x-1)^{4/3}} \dx{x}$.
...
\begin{egg}
Évaluons l'intégrale
$\DS \int_1^\infty \frac{\ln(x)}{x^3} \dx{x}$.
...
$\DS \int_1^\infty \frac{1}{x^p} \dx{x}$ converge.  Pour les
...
$\DS \int_1^\infty \frac{1}{x^p} \dx{x}$ converge pour $p>1$
...
$\DS \int_1^\infty \frac{1}{x^p} \dx{x}$
par $\DS \int_a^\infty \frac{1}{x^p} \dx{x}$
où $a$ est un nombre réel quelconque.

\begin{egg}
Évaluons si possible l'intégrale impropre
$\DS \int_{-\infty}^\infty \frac{1}{x^2+2x+2} \dx{x}$.
...
$\DS \lim_{q\rightarrow \infty} q = +\infty$ et
$\DS \lim_{q\rightarrow \infty} e^q = +\infty$.
\end{egg}
...
\PDFfig{7_integrales/improper4}{Graphe de $\DS y=\frac{1}{x^2+x-6}$}
{Graphe de $\DS y=\frac{1}{x^2+x-6}$ pour $0\leq x < 2$.}{IMPR4} 

\begin{egg}
Déterminons si l'intégrale impropre
$\DS \int_0^2 \frac{1}{x^2+x-6} \dx{x}$ converge ou diverge.
...
\end{align*}
Puisque $\DS \lim_{q\rightarrow 2^-} \ln|q-2| = -\infty$ et
$\DS \lim_{q\rightarrow 2^-} \ln(q+3) = \ln(5)$, nous obtenons
\begin{align*}
\int_0^2 \frac{1}{x^2+x-6} \dx{x}
&= \lim_{q\rightarrow 2^-} \int_0^q \frac{1}{x^2+x-6} \dx{x} \\
...
$\DS \int_0^1 \frac{1}{x^p} \dx{x}$ converge.  Pour les
...
\begin{prop}
$\DS \int_0^1 \frac{1}{x^p} \dx{x}$ converge pour
$p<1$ et diverge pour $p\geq 1$.  De plus,
$\DS \int_0^1 \frac{1}{x^p} \dx{x} = \frac{1}{1-p}$
pour $p<1$.
\label{impr_comp2}
\end{prop}
...
La conclusion de la proposition précédente au sujet de la convergence
ou divergence ne changera pas si nous remplaçons
$\DS \int_0^1 \frac{1}{x^p} \dx{x}$ par
$\DS \int_0^a \frac{1}{x^p} \dx{x}$
...
nous avons $\DS \dx{t} = \frac{-1}{x^2} \dx{x}$ et
\[
...
\begin{enumerate}
\item Si $\DS \int_a^b g(x) \dx{x}$ converge alors
$\DS \int_a^b f(x) \dx{x}$ converge.
\item Si $\DS \int_a^b f(x) \dx{x}$ diverge alors
$\DS \int_a^b g(x) \dx{x}$ diverge.
\end{enumerate}
\end{theorem}
...
$\DS \int_a^{+\infty} g(x) \dx{x}$.  Il s'en suit que
\[
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{1em}}l@{\hspace{5em}}}l@{\hspace{1em}}l}
\subQ{a} & $\DS \int_1^\infty \frac{|\sin(x)|}{x^2} \dx{x}$  &
\subQ{b} & $\DS \int_1^\infty \frac{x^2}{x^3-x+1}\dx{x}$
\end{tabular}
\end{center}
...
nous avons que
\[
\DS \int_1^\infty \frac{|\sin(x)|}{x^2} \dx{x}
\]
converge grâce au test de comparaison.

\subQ{b} Remarquons que
$\DS \frac{x^2}{x^3-x+1} > \frac{1}{x}$ pour $x\geq 1$.  En effet,
...
nous avons que
\[
\DS \int_1^\infty \frac{x^2}{x^3-x+1}\dx{x}
\]
...
$\DS \int_1^5 \frac{1}{(x^2-1)^{1/3}} \dx{x}$
converge ou diverge.
...
$\DS \int_1^5 \frac{1}{(x^2-1)^{1/3}} \dx{x}$ converge si et
seulement si $\DS \int_0^{4} \frac{1}{(u^2+2u)^{1/3}} \dx{u}$
...
$]a,b[$.   Alors $\DS \int_a^b f(x) \dx{x}$
converge si $\DS \int_a^b |f(x)| \dx{x}$ converge.
Les bornes d'intégration $a$ et $b$ peuvent être $+\infty$
ou $-\infty$, ou ils peuvent correspondent à des asymptotes verticales
pour la fonction $f$. 
\end{theorem}

Par exemple, $\DS \int_a^{\infty} f(x) \dx{x}$
converge si $\DS \int_a^{\infty} |f(x)| \dx{x}$ converge.
...
c'est-à-dire, $\DS \int_a^{\infty} |f(x)| \dx{x}$.
...
$\DS \int_a^{\infty} f(x) \dx{x}$ est finie
...
Si $\DS \int_a^\infty |f(x)| \dx{x}$ converge alors
$\DS \int_a^\infty 2|f(x)| \dx{x}$ converge
car
\[
...
$\DS \int_a^\infty \left( |f(x)| - f(x) \right) \dx{x}$
converge grâce au test de comparaison.

Finalement, $\DS \int_a^\infty f(x) \dx{x}$ converge car
\begin{align*}
...
$\DS \int_1^\infty \frac{|\sin(x)|}{x^2} \dx{x}$ convergeait.
Il s'en suit que l'intégrale
$\DS \int_1^\infty \frac{\sin(x)}{x^2} \dx{x}$ converge.
\end{egg}

\begin{rmk}[\theory]
Si $\DS \int_a^b |f(x)| \dx{x}$ diverge, nous ne pouvons rien dire au
sujet de $\DS \int_a^b f(x) \dx{x}$.

Par exemple, $\DS \int_1^\infty \frac{\sin(x)}{x} \dx{x}$
converge mais
$\DS \int_1^\infty \left| \frac{\sin(x)}{x} \right| \dx{x}$
diverge.

\subQ{i} Commençons par montrer que
$\DS \int_1^\infty \frac{\sin(x)}{x} \dx{x}$ converge.
...
\]
et $\DS \int_1^\infty \frac{1}{x^2} \dx{x}$ converge grâce
à la proposition~\ref{impr_comp1}, nous avons que
\[
\int_1^\infty \left| \frac{\cos(x)}{x^2} \right| \dx{x}
\]
converge.  Donc
$\DS \int_1^\infty \frac{\cos(x)}{x^2} \dx{x}$ converge.  De
plus
\[
...
\begin{cases}
\DS \int_0^{\pi} \sin(x) \dx{x} = -\cos(x)\bigg|_0^\pi = 2 & \quad
\text{pour $k$ pair.} \\[1em]
\DS \int_\pi^{2\pi} -\sin(x) \dx{x} = \cos(x)\bigg|_\pi^{2\pi}
...
tout $x$ et telle que $\DS \int_a^b\,p(x) \dx{x}$ est simple
...
La somme
$\DS 2h \sum_{i=0}^{n-1} f(x_{2i+1})$ est une somme de
Riemann avec $\Delta x = 2h$ pour l'intégrale
$\DS \int_a^b f(x) \dx{x}$.  Donc, en théorie,
$\DS 2h \sum_{i=0}^{n-1} f(x_{2i+1})$ tend vers
$\DS \int_a^b f(x) \dx{x}$ lorsque $h$ tend vers $0$.  Nous
...
l'intégrale $\DS \int_0^1 e^{x^2}\dx{x}$.  Nous allons
...
$\DS h = \frac{1}{2n} = \frac{1}{166}$ et
$\DS x_{2i+1} = \frac{2i+1}{166}$ pour $i=0$, $1$, $2$, \ldots, $82$,
Nous obtenons
\begin{align*}
...
$\DS \int_0^1 e^{x^2}\dx{x}$.  Nous allons choisir le nombre de
...
$\DS \int_1^\infty e^{-x^2/2} \dx{x}$ avec une précision de
$10^{-4}$.
...
$\DS \int_1^c e^{-x^2/2} \dx{x}$ telle que
\[
...
approximation de $\DS \int_1^\infty e^{-x^2/2} \dx{x}$.
...
$\DS h = \frac{1}{2n} = \frac{1}{12}$ et
$\DS x_i = \frac{i}{12}$ pour $i=0$, $1$, $2$, \ldots, $12$.
Nous obtenons
\begin{align*}
...
\subQ{a} & $\DS \int -x^{-2} \dx{x}$ &
\subQ{b} & $\DS \int \frac{10}{x^9} \dx{x}$ &
\subQ{c} & $\DS \int \left(5z^{-1.2} -1.2\right) \dx{z}$ \\
\subQ{d} & $\DS \int \left( \frac{1}{\sqrt[5]{t}}
+ 3t \right) \dx{t}$ &
\subQ{e} & $\DS \int 2^x \dx{x}$ &
\subQ{f} & $\DS \int \left( e^x + \frac{1}{x}\right) \dx{x}$ \\[1em]
\subQ{g} & $\DS \int \frac{(3t+2)^2}{4t^2}\dx{t}$ &
\subQ{h} & $\DS \int \frac{(x^{1/3} + 1)^2}{x^{2/3}} \dx{x}$ & &
\end{tabular}
\end{center}
\label{7Q1}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int \frac{1}{1+4t} \dx{t}$ &
\subQ{b} & $\DS \int \frac{1}{5-3x} \dx{x}$ &
\subQ{c} & $\DS \int 3 e^{3x/7} \dx{x}$ \\[0.8em]
\subQ{d} & $\DS \int \left( 1 + \frac{t}{3}\right)^7 \dx{t}$ &
\subQ{e} & $\DS \int \frac{e^z}{1+ e^z} \dx{z}$ &
\subQ{f} & $\DS \int 3y \sqrt{1+y^2} \dx{y}$ \\[0.8em]
\subQ{g} & $\DS \int \frac{1}{x\ln(x)} \dx{x}$ &
\subQ{h} & $\DS \int \frac{1+4x}{\sqrt{1+x+2x^2}} \dx{x}$ &
\subQ{i} & $\DS \int x^2 \sqrt{x^3+1} \dx{x}$ \\[0.8em]
\subQ{j} & $\DS \int e^t\left( 1 + e^t\right)^4 \dx{t}$ &
\subQ{k} & $\DS \int \frac{1}{\sqrt{x}(1+\sqrt{x})^{11}}
\dx{x}$ &
\subQ{l} & $\DS \int \frac{e^{1/t}}{t^2} \dx{t}$ \\[0.8em]
\subQ{m} & $\DS \int \frac{\ln(x)}{x} \dx{x}$ &
\subQ{n} & $\DS \int \frac{x+3}{x^2-9} \dx{x}$ &
\subQ{o} & $\DS \int e^{t}\left( 2 + e^{2t}\right) \dx{t}$ \\[0.8em]
\subQ{p} & $\DS \int \frac{t^{3/5}}{1+t^{2/5}} \dx{t}$ &
\subQ{q} & $\DS \int \frac{x}{(1+x^2)^9}\dx{x}$ &
\subQ{r} & $\DS \int \frac{x^3}{(1+x^2)^9}\dx{x}$
\end{tabular}
\end{center}
\label{7Q2}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int \cos(2\pi(x-2)) \dx{x}$ &
\subQ{b} & $\DS \int \frac{\cos(\theta)}{1-\cos^2(\theta)}
\dx{\theta}$ &
\subQ{c} & $\DS \int \frac{\sin(x)}{1-\sin^2{x}} \dx{x}$ \\[0.8em]
\subQ{d} & $\DS \int \sqrt{x}\, \sin(x^{3/2}+1) \dx{x}$ &
\subQ{e} & $\DS \int \frac{\cos(1/t)}{t^2} \dx{t}$ &
\subQ{f} & $\DS \int \frac{1}{x^2+9} \dx{x}$ \\[0.8em]
\subQ{g} & $\DS \int \frac{x^3+1}{x^2+3} \dx{x}$ &
\subQ{h} & $\DS \int \frac{x}{\sqrt{4-x^4}} \dx{x}$ &
\subQ{i} & $\DS \int \tan(x) \sec^4(x) \dx{x}$ \\[0.8em]
\subQ{j} & $\DS \int \frac{1}{2 - \cos(x)} \dx{x}$ &
\subQ{k} & $\DS \int x^2 \sin(x^3+1) \dx{x}$ &
\subQ{l} & $\DS \int \frac{(2t+1)^2}{1+t^2}\dx{t}$ \\[0.8em]
\subQ{m} & $\DS \int \sin^5(x) \cos^4(x) \dx{x}$ &
\subQ{n} & $\DS \int \frac{\sin^5(x)}{\cos^4(x)} \dx{x}$ &
\subQ{o} & $\DS \int \cos^3(x) \sin^2(x) \dx{x}$
\end{tabular}
\end{center}
\label{7Q3}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int \ln\left(\sqrt{x}\right) \dx{x}$ &
\subQ{b} & $\DS \int x^2 e^x \dx{x}$ &
\subQ{c} & $\DS \int \frac{x}{e^{3x}} \dx{x}$ \\[0.8em]
\subQ{d} & $\DS \int x^2 \, e^{-x} \dx{x}$ &
\subQ{e} & $\DS \int x^3 \, e^{x^2} \dx{x}$ &
\subQ{f} & $\DS \int (x^2+x^6)\ln(x) \dx{x}$  \\[0.8em]
\subQ{g} & $\DS \int x^3\ln\left(x^2+2\right) \dx{x}$ &
& & &
\end{tabular}
\end{center}
\label{7Q4}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int \theta \cos(\pi\theta) \dx{\theta}$ &
\subQ{b} & $\DS \int e^x \sin(x) \dx{x}$ &
\subQ{c} & $\DS \int \theta^3 \sin(\theta^2) \dx{\theta}$
\end{tabular}
\end{center}
\label{7Q5}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int \frac{x^4+3}{x^2-4x+3} \dx{x}$ &
\subQ{b} & $\DS \int \frac{x-9}{(x+5)(x-2)} \dx{x}$ &
\subQ{c} & $\DS \int \frac{1}{x^2+x+1} \dx{x}$ \\[0.8em]
\subQ{d} & $\DS \int \frac{1}{t^2+6t+8} \dx{t}$ &
\subQ{e} & $\DS \int \frac{1}{x^2-4x+13} \dx{x}$ &
\subQ{f} & $\DS \int \frac{1}{x^2-9}\dx{x}$ \\[0.8em]
\subQ{g} & $\DS \int \frac{1}{x^2 -x -2} \dx{x}$ &
\subQ{h} & $\DS \int \frac{t^2+1}{t^2+3t+2} \dx{t}$ &
\subQ{i} & $\DS \int \frac{x^3-x-2}{x^2-4} \dx{x}$ \\[0.8em]
\subQ{j} & $\DS \int \frac{9x+29}{x^2+2x-15}\dx{x}$ &
& & &
\end{tabular}
\end{center}
...
\subQ{a} & $\DS \int \frac{x^2-x+6}{x^3+3x} \dx{x}$ &
\subQ{b} & $\DS \int \frac{x^2 -3x -23}{(x-2)(x+3)^2} \dx{x}$
\end{tabular}
\end{center}
\label{7Q7}
\end{question}
...
pour l'intégrale $\DS \int_0^1 (1+t^3)\dx{t}$ où
...
$\DS \int_0^2 t^2 \dx{t}$ lorsque la partition de l'intervalle
...
$\DS \int_1^6 f(x)\dx{x}$ lorsque l'intervalle $[1,6]$ est
...
\begin{question}
La somme $\DS 0.4 ( 0.4^3 + 0.8^3 + 1.2^3 + 1.6^3 + 2^3)$
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{6em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_{4}^{9} f(x) \dx{x}$ &
\subQ{b} & $\DS \int_{-2}^{2} f(x) \dx{x}$
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{6em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_{-2}^{5} f(x) \dx{x}$ &
\subQ{b} & $\DS \int_{0}^{10} f(x) \dx{x}$
\end{tabular}
\end{center}
...
\begin{question}
Si $\DS \int_2^8 f(x) \dx{x} = 5$ et
$\DS \int_5^8 f(x) \dx{x} = 7$, calculez les intégrales
définies suivantes.
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_2^5 f(x) \dx{x}$ &
\subQ{b} & $\DS \int_5^8 (2f(x)+3x)\dx{x}$ &
\subQ{c} & $\DS \int_{-2/3}^{2/3} f(2-3t) \dx{t}$
\end{tabular}
\end{center}
\label{7Q28}
\end{question}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{6em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_1^5 \frac{5}{x^3} \dx{x}$ &
\subQ{b} &
$\DS \int_1^8 \left( \frac{2}{\sqrt[3]{x}} +3\right)\dx{x}$ \\[0.8em]
\subQ{c} & $\DS \int_1^4 \left(e^x + \frac{1}{x}\right)\dx{x}$ &
\subQ{d} & $\DS \int_1^2 \frac{3}{t^4} \dx{t}$
\end{tabular}
\end{center}
\label{7Q29}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_0^5 3 e^{x/5} \dx{x}$ &
\subQ{b} & $\DS \int_0^4 \left(1+\frac{t}{2}\right)^4 \dx{t}$ &
\subQ{c} & $\DS \int_{1}^{10} (1+2t)^{-4} \dx{t}$ \\[0.8em]
\subQ{d} & $\DS \int_{0}^{2} \frac{1}{1+4t} \dx{t}$ &
\subQ{e} & $\DS \int_0^1 x^2(1+2x^3)^5 \dx{x}$ &
\subQ{f} & $\DS \int_1^4 \frac{e^{\sqrt{x}}}{\sqrt{x}} \dx{x}$
  \\[0.8em]
\subQ{g} & $\DS \int_1^e \frac{1}{x(1+(\ln(x))^2)} \dx{x}$ &
\subQ{h} & $\DS \int_1^e x^2 \ln(x) \dx{x}$  &
\subQ{i} & $\DS \int_1^2 \frac{4x^2 -14x+10}{2x^2-7x+3} \dx{x}$
\end{tabular}
\end{center}
\label{7Q30}
\end{question}
...
$\DS F_n = \int_0^1 \frac{x^n}{(1+x)^n} \dx{x}$.
\label{7Q31}
\end{question}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{6em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_0^\pi\left(2\sin(\theta)+3\cos(\theta)\right)$ &
\subQ{b} & $\DS \int_{\pi/2}^{3\pi/4} \sin^5(x) \cos^3(x)
\dx{x}$ \\[0.9em]
\subQ{c} & $\DS \int_0^{\pi/2} \sin^2(x)\cos^2(x)\dx{x}$ &
\subQ{d} & $\DS \int_0^{\pi/4} \tan^2(x)\sec^4(x)\dx{x}$ \\[0.9em]
\subQ{e} & $\DS \int_0^2 \frac{x^3+x+1}{x^2+4} \dx{x}$ &
\subQ{f} & $\DS \int_0^1 \frac{1}{(1 + 2x -x^2)^{1/2}} \dx{x}$
\end{tabular}
\end{center}
\label{7Q32}
\end{question}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{6em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_{\sqrt{2}}^{2} \frac{1}{t^3\sqrt{t^2-1}} \dx{x}$ &
\subQ{b} & $\DS \int_0^{2\sqrt{3}} \frac{t^3}{\sqrt{16-t^2}} \dx{t}$
\end{tabular}
\end{center}
\label{7Q33}
\end{question}
...
\subQ{a} & $\DS \int_{-2}^{2}\left(y^4+5y^3\right) \dx{y}$ &
\subQ{b} & $\DS \int_{-a}^{a} x \sqrt{x^2+a^2} \dx{x}$
\end{tabular}
\end{center}
\label{7Q34}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_{-\pi/2}^{\pi/2}\left(x^2 -20
\sin(x)\right) \dx{x}$ &
\subQ{b} & $\DS \int_{2}^{5}\cos(2\pi(x-2)) \dx{x}$ &
\subQ{c} & $\DS \int_{-\pi}^{\pi} x^{16} \sin(2x) \dx{x}$
\end{tabular}
\end{center}
\label{7Q35}
\end{question}
...
\begin{question}[\eng \life]
Vérifiez que $\DS \dfdx{ \int_a^x f(s) \dx{s} }{x} = f(x)$ pour
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{6em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS g(y) = \int_2^y t^2\sin(t) \dx{t}$ &
\subQ{b} & $\DS h(x) = \int_2^{1/x} \arctan(t) \dx{t}$
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_0^\infty e^{-3x} \dx{x}$ &
\subQ{b} & $\DS \int_0^\infty \frac{1}{(2+5x)^4} \dx{x}$ &
\subQ{c} & $\DS \int_0^\infty \frac{1}{\sqrt[3]{x}} \dx{x}$ \\[0.8em]
\subQ{d} & $\DS \int_2^\infty \frac{1}{x\sqrt{x}}\,\dx{x}$ &
\subQ{e} & $\DS \int_1^e \frac{2}{x\sqrt{\ln(x)}} \dx{x}$ &
\subQ{f} & $\DS \int_{-\infty}^0 3x^2 e^{-x^3} \dx{x}$ \\[0.8em]
\subQ{g} & $\DS \int_{-1}^1 \frac{x+1}{\sqrt[3]{x^4}} \dx{x}$ &
\subQ{h} & $\DS \int_0^\infty x\,e^{-x} \dx{x}$ &
\subQ{i} & $\DS\int_0^3\frac{2}{(x-2)^{4/3}}\dx{x}$ \\[0.8 em]
\subQ{j} & $\DS \int_0^\infty \frac{x}{1+x^4} \dx{x}$ &
\subQ{k} & $\DS \int_0^\infty \frac{1}{(1+3x)^{3/2}} \dx{x}$ &
\subQ{l} & $\DS \int_0^4 \frac{1}{x^2+x-6} \dx{x}$ \\[0.8em]
\subQ{m} & $\DS \int_0^2 \,\frac{1}{4-x^2} \, \dx{x}$ &
\subQ{n} & $\DS \int_1^2\frac{3}{\sqrt[3]{x-1}} \dx{x}$ &
\subQ{o} & $\DS \int_0^{\pi/2}
\frac{\sin(x)}{\sqrt{\cos(x)}} \dx{x}$ \\[0.8em]
\subQ{p} & $\DS \int_1^2 \frac{x}{\sqrt{2-x}} \dx{x}$ &
\subQ{q} & $\DS \int_0^8 \frac{x}{(8-x)^{2/3}} \dx{x}$ & &
\end{tabular}
\end{center}
\label{7Q38}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_0^1 \frac{1}{x^{1/3} + x^3} \dx{x}$ &
\subQ{b} & $\DS \int_1^\infty \frac{1}{x^{1/3}+x^3} \dx{x}$ &
\subQ{c} & $\DS \int_1^\infty \frac{x}{x^2+x^{4/3}} \dx{x}$
\end{tabular}
\end{center}
\label{7Q39}
\end{question}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \int_0^1 \frac{1}{x^2\, e^x} \dx{x}$ &
\subQ{b} & $\DS \int_1^\infty \frac{1}{\sqrt{x}+ e^x} \dx{x}$ &
\subQ{c} & $\DS \int_1^\infty \frac{\sin^2(x)}{x^3 + 2} \dx{x}$
\\[1em]
\subQ{d} & $\DS \int_1^\infty\frac{1+\cos^2x}{x^2} \dx{x}$ &
\subQ{e} & $\DS \int_0^1 \frac{2\sqrt{x}+1}{x^4+3x} \dx{x}$ &
\subQ{f} & $\DS \int_1^\infty
\frac{x^2 \cos^2 x + 1}{x^4 + x^2 + 1} \dx{x}$ \\[1em]
\subQ{g} & $\DS \int_1^\infty \frac{2\sqrt{x}+3}{x^2+2x} \dx{x}$ &
& & &
\end{tabular}
\end{center}
\label{7Q40}
