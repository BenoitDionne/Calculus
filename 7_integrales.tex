...
\begin{focus}{\dfn} \index{Primitive}
...
\begin{focus}{\dfn}\index{Intégrale indéfinie}\index{Intégrande}
...
\begin{focus}{\thm} \index{Règle de substitution}
...
\begin{focus}{\thm} \index{Intégration par parties}
Si $f$ et $g$ sont deux fonctions différentiables, alors
\[
...
\begin{focus}[][Somme de Riemann]{\dfn} \index{Somme de Riemann}
...
\begin{focus}[][Théorème fondamental du calcul]{\thm}
...
\begin{focus}[][Deuxième version du théorème fondamental du calcul]{\thm}
...
\begin{focus}{\dfn}\index{Intégrale impropre!sur un domaine non borné}
...
\begin{focus}{\dfn} \index{Intégrale impropre!pour une fonction non bornée}
\index{Intégrale impropre!convergence}\index{Intégrale impropre!divergence}
...
\begin{focus}[][Test de comparaison]{\thm}
...
\begin{focus}[][Méthode du point milieu]{\mth} 
...
\begin{focus}[][Méthode des trapèzes]{\mth}
...
\begin{focus}[][Méthode de Simpson]{\mth} \index{Méthode de Simpson}
Une approximation de la valeur de l'intégrale de $f$ sur l'intervalle
$[a,b]$ est donnée par la formule suivante.
\[
