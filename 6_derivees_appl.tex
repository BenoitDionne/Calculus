...
\begin{defn} \index{Point critique}
...
\begin{defn}\index{Dérivée seconde}\index{Dérivée d'ordre supérieure}
...
\begin{defn} \index{Point d'inflexion} 
...
\begin{prop}[Test de la dérivée première]
...
\begin{prop}[Test de la dérivée seconde]
...
suites $\DS \left\{x_n\right\}_{n=0}^\infty$ qui tendent
...
\begin{egg}
Traçons le graphe de $\DS f(x) = \frac{1}{(x-1)(x-2)}$.
...
$\DS \sum_{n=1}^\infty (-1)^n a_n$ avec 
\[
a_n = \frac{\sqrt{n}}{n^{2/3}+1} > 0
\]
pour tout $n$.  De plus $\DS \lim_{n\rightarrow \infty} a_n = 0$
...
\]
pour tout $n$ et
$\DS \lim_{n\rightarrow \infty} \frac{1}{n^{1/6}} = 0$.
...
\begin{theorem}[Théorème des valeurs extrêmes]
...
Si $\DS p(t) = \frac{t}{1+t}$ et $C=3$, pour quelle valeur
de $t$ aurons-nous la plus grande proportion $w(t)$ d'oeufs pondus qui
écloront?

Nous obtenons de $\DS w(t) = \frac{t}{(t+1)(t+3)}$ que
\[
...
Si nous dérivons $\DS w(t) = \frac{p(t)}{t+C}$ par rapport à
$t$, nous trouvons que
\[
...
$\DS \dydx{x}{t}(t) = 140$ km/h pour tout $t$.
...
Nous avons que $\DS \dydx{R}{t}(t) = -0.01$ mm/m pour tout $t$.
...
\]
Puisque $\DS \dydx{x}{t}(t) = 4000$ m/h pour tout $t$, nous avons
\[
...
2$^e$ méthode:  Nous pouvons calculer $\DS \dydx{y}{x}$ en un
...
$\DS \frac{x^2}{3} + \frac{y^2}{6} = 1$ au point $(1,2)$.
...
$\DS y -1 = -1 (x-1)$.  Ce qui donne $y = -x + 1$
...
la forme $\DS \lim_{n\rightarrow a} \frac{f(x)}{g(x)}$ où
$\DS \lim_{n\rightarrow a} f(x) = 0$ et
$\DS \lim_{n\rightarrow a} g(x) = 0$.

\begin{egg}
Calculons les limites suivantes.
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{1em}}l@{\hspace{5em}}}l@{\hspace{1em}}l}
\subQ{a} & $\DS \lim_{x\rightarrow 0} \frac{x-\sin(x)}{x^2}$ &
\subQ{b} & $\DS \lim_{x\rightarrow 0} \frac{1-\cos(2x)}{1+x-e^x}$
\end{tabular}
\end{center}
...
\[
\frac{1-\cos(2x)}{1+x-e^x} = \frac{\DS 2\,x^2 - r_2(2x)}
{\DS -\frac{x^2}{2!} - \hat{r}_2(x)}
= \frac{\DS 2 - \frac{r_2(2x)}{x^2}}
{\DS -\frac{1}{2} - \frac{\hat{r}_2(x)}{x^2}} \; .
\]
Puisque
\[
...
= \frac{\DS 2 - \frac{r_2(2x)}{x^2}}
{\DS -\frac{1}{2} - \frac{\hat{r}_2(x)}{x^2}}
\rightarrow \frac{2}{\DS -\frac{1}{2}} = -4 \quad
...
\begin{defn} \index{Comportement asymptotique à l'infini}
...
$\DS \left\{ x_n \right\}_{n=0}^\infty$ où
$x_n = 10^n$ pour $n=0$, $1$, $2$, \ldots\  La suite
$\DS \left\{ x_n \right\}_{n=0}^\infty$ tend vers plus
l'infini.
\[
...
\]
La suite
$\DS \left\{ \frac{\ln(x_n)}{x_n^{1/5}} \right\}_{n=0}^\infty$
semble bien tendre vers $0$.  Nous pourrions montrer que c'est le cas
pour toute suite
$\DS \left\{ x_n \right\}_{n=0}^\infty$ qui tend vers plus
l'infini.  Donc
\[
...
\begin{defn} \index{Comportement asymptotique à l'origi\-ne}
Soit $f$ et $g$ deux fonctions telles que
\[
...
$\DS \left\{ x_n \right\}_{n=0}^\infty$ où $x_n = 1/n^2$
...
\]
La suite
$\DS \left\{ \frac{x_n^5}{e^{x_n}-1} \right\}_{n=0}^\infty$
semble tendre vers $0$.  Nous pourrions montrer que c'est le cas pour
toute suite $\DS \left\{ x_n \right\}_{n=0}^\infty$ qui tend
vers l'origine (même si certains des termes de la suite
$\DS \left\{ x_n \right\}_{n=0}^\infty$ sont négatifs).
Donc
\[
...
\begin{theorem}[Règle de l'Hospital] \index{Règle de l'Hospital}
...
$\DS \lim_{x\rightarrow c} \frac{f(x)}{g(x)}$ avec
$\DS \lim_{x\rightarrow c} f(x) = \lim_{x\rightarrow c} g(x) = 0$
ou $\DS \lim_{x\rightarrow c} g(x) = \pm \infty$, il faut
souvent calculer
$\DS \lim_{x\rightarrow c^+} \frac{f(x)}{g(x)}$
et $\DS \lim_{x\rightarrow c^-} \frac{f(x)}{g(x)}$.  Si
...
\begin{lemma}[Théorème de la moyenne de Cauchy+\theory]
...
\begin{proof}[Démonstration (Règle de l'Hospital) \theory]
...
$\DS \lim_{x\to \infty} x^3 = \lim_{x\to \infty} e^{\alpha x}
= \infty$, dans le deuxième cas 
$\DS \lim_{x\to \infty} 3x^2 = \lim_{x\to \infty} \alpha e^{\alpha x}
= \infty$, et dans le troisième cas
$\DS \lim_{x\to \infty} 6x = \lim_{x\to \infty} \alpha^2 e^{\alpha x}
= \infty$.
\end{egg}
...
\]
Donc $\DS \lim_{x\rightarrow 0}\frac{\sin(x)-x}{x^2} = 0$.
\end{egg}
...
\subQ{a} & $\DS \lim_{x\rightarrow \infty} \frac{\ln(e^x+x)}{x}$ &
\subQ{b} & $\DS \lim_{x\rightarrow \infty} (e^x+x)^{1/x}$
\end{tabular}
\end{center}
...
\]
car $\DS \sin\left(\frac{\pi x}{2}\right)$ est une fonction
continue.  Comme
$\DS \lim_{x\to 1^-} \frac{(x-1)}{\cos(\pi x/2)}$
...
\frac{\DS \ln\left(1+\frac{a}{x}\right)}{(1/x)} \; .
\]
...
&= \lim_{x\rightarrow \infty}
\frac{\DS\ln\left(1+\frac{a}{x}\right)}{(1/x)}
= \lim_{x\rightarrow \infty} \frac{\DS \left(1+\frac{a}{x}\right)^{-1}
\left(-\frac{a}{x^2}\right)}{\DS \left(-\frac{1}{x^2}\right)} \\
&= \lim_{x\rightarrow \infty} a\left(1+\frac{a}{x}\right)^{-1}
= a\left(1+\lim_{x\rightarrow \infty} \frac{a}{x}\right)^{-1} = a
\end{align*}
car $\DS \lim_{x\to \infty} \frac{a}{x} = 0$.  La second
...
$\DS \sum_{n=1}^\infty (-1)^n\;\frac{\ln(n)}{n}$ converge.

Nous avons une série alternée de la forme
$\DS \sum_{n=1}^\infty (-1)^n a_n$ où $a_n = \ln(n)/n$.  Nous
...
$\DS \sum_{n=3}^\infty (-1)^n \frac{\ln(n)}{n}$ converge.
Puisque
\[
...
$\DS \sum_{n=1}^\infty (-1)^n \frac{\ln(n)}{n}$ converge.  En effet,
\begin{align*}
...
% \begin{egg}[\eng]
% Déterminer si la série $\DS \sum_{n=1}^\infty\frac{\ln(n)}{2^n}$ 
% converge.
...
$\DS \left\{ x_n \right\}_{n=0}^\infty$ qui converge vers une
racine de $f$.

\begin{meth}[Méthodes de Newton] \index{Méthode de Newton}
\begin{enumerate}
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ est produite avec la
...
suite $\DS \left\{x_n\right\}_{n=0}^\infty$ produite par la
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ produite avec la
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ produite à l'aide de la
...
$\DS \left\{t_n\right\}_{n=0}^\infty$ générée par la méthode
de Newton.
\[
\begin{array}{|c|c|c|}
\hline
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ générée par la 
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ qui tend vers la
racine dans ce petit intervalle.

\begin{meth}[Méthode de bissection] \index{Méthode de bissection}
...
$\DS \left\{p_n\right\}_{n=0}^\infty$ lorsque $n$ devient de
...
\begin{defn} \index{Système dynamique discret!orbite d'une solution}
Soit
\[
p_{n+1}= f(p_n) \quad \text{pour} \quad n=0, 1, 2, \ldots
\]
un système dynamique discret.  L'{\bfseries orbite} (positive) de
$p_0$ est la suite $\DS \left\{ p_n \right\}_{n=0}^\infty$
...
$p_0> 0$, l'orbite $\DS \left\{ p_n \right\}_{n=0}^\infty$
...
l'orbite $\DS \left\{ p_n \right\}_{n=0}^\infty$ de $p_0$
...
Remarquons que l'orbite $\DS \left\{ p_n \right\}_{i=0}^\infty$
...
\begin{defn}\index{Système dynamique discret!point d'équilibre}
...
$\DS \left\{ p_n\right\}_{n=0}^\infty$ du 
système dynamique discret
\[
...
$\DS \left\{ p_n\right\}_{n=0}^\infty$ tend vers $p$.
...
de $p$, l'orbite $\DS \left\{ p_n\right\}_{n=0}^\infty$
...
$\DS \left\{ p_n\right\}_{n=0}^\infty$ avec la condition
...
$\DS p_{n+1} = \alpha p_n + \beta$ et que
...
n=0,1,2,\ldots
\end{equation}
où le facteur $\DS \left( 1 - \frac{p_n}{M}\right)$ devient
...
\begin{defn} \index{Équation logistique}
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ tendra vers l'état
...
$p = 1/11$, l'orbite $\DS \left\{x_n\right\}_{n=0}^\infty$
tend vers $p$.  De même, pour une condition initiale
$x_0$ entre $p=1/11$ et $1$, l'orbite
$\DS \left\{x_n\right\}_{n=0}^\infty$ tend aussi vers $p$.
...
alors l'orbite $\DS \left\{x_n\right\}_{n=0}^\infty$ demeure 
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ alterne entre la
...
\begin{theorem} \label{sdd_stab_th}
...
\begin{proof}[Démonstration (Théorème~\ref{sdd_stab_th}) \theory]
...
$p_H$ est stable et donc $\DS \{p_n\}_{n=1}^\infty$ converge vers
...
$\DS \left\{ x_n\right\}_{n=0}^\infty$ ne tend pas vers un
...
\]
avec $r=3.47$, l'orbite $\DS \left\{ x_n\right\}_{n=0}^\infty$
...
$\DS \left\{ x_n \right\}_{n=0}^\infty$ est une orbite du
système dynamique discret
\[
x_{n+1} = f(x_n) \quad , \quad n=0, 1, 2, \ldots
\]
...
$\DS \left\{ x_n \right\}_{n=0}^\infty$ est appelée une
...
$\DS \left\{ x_n\right\}_{n=0}^\infty$ se comporte de plus
...
$\DS \left\{ x_n \right\}_{n=0}^\infty$ une orbite périodique
...
\subQ{a} & $\DS h(y) = y^{10}-y^9$ &
\subQ{b} & $\DS f(x) = \frac{3+x}{2x}$ &
\subQ{c} & $\DS f(x) = x^2 e^x$ \\
\subQ{d} & $\DS f(x) = \frac{1+x}{e^x}$ &
\subQ{e} & $\DS g(z) = (z+4)\ln(z)$ &
\subQ{f} & $\DS F(w) = e^w \ln(w)$ \\
\subQ{g} & $\DS f(x) = \ln(x^7)$ &
\subQ{h} & $\DS f(z) = \frac{1+e^{-z}}{1+e^z}$ &
\subQ{i} & $\DS F(y) = \frac{\ln(y)}{e^y}$ \\[0.9em]
\subQ{j} & $\DS f(x) = 1 + x^{4/5}$ &
\subQ{k} & $\DS f(x)= \frac{2+x^3}{1+x^2}$
\end{tabular}
\end{center}
\label{6Q1}
\end{question}
...
par $\DS V_a(t) = t^2 - 3t + 16$ pour la ville $A$ et
...
$\DS f(p) = 2\left( 1- \frac{p}{1000}\right)$.
...
$\DS f(x)=\frac{e^{2x^2}}{x}$ possède un 
minimum ou un maximum local.
\label{6Q16}
\end{question}

\begin{question}
Soit $\DS f(x) = x\sqrt{5-x}$ pour $x<5$.  Répondre aux questions
suivantes.
...
\begin{question}[\life \eng]
Soit $\DS f(x) = x - 2\sin(x)$ pour $0<x<3\pi$. Répondre aux
questions suivantes.
...
$\DS \lim_{x\to 1}f(x)=-2$,
$\DS \lim_{x\to 3^-} f(x) = -\infty$ et
$\DS \lim_{x\to 3^+}f(x)= \infty$;
...
\subQ{c} & $f(x) = x + 4/x^2$ &
\subQ{d} & $\DS f(x) = (1-x)e^x$ \\
\subQ{e} & $\DS g(z) = \frac{e^z}{z^2}$ &
\subQ{f} & $F(z) = z^3/e^z$ \\[0.5em]
\subQ{g} & $T(t) = (1-t^2) e^t$\ ,\ $-1 \leq t \leq 1$ &
\subQ{h} & $G(x) = \sqrt{x}\; e^{-x}$\ ,\ $x\geq 0$ \\
\subQ{i} & $\DS f(x) = \frac{x^3}{1+x^3}$  &
\subQ{j} & $\DS f(x) = \frac{2}{x^2} - \frac{3}{x^3}$ \\[0.8em]
\subQ{k} & $\DS f(x) = (x+4)e^{-x}$ &
\subQ{l} & $\DS f(x) = \frac{2}{x} -\frac{6}{x^3}$ \\[0.5em]
\subQ{m} & $\DS f(x) = \frac{e^x}{x-1}$ &
\subQ{n} & $\DS f(x) = \frac{x}{x^3+1}$ \\[0.5em]
\subQ{o} & $\DS f(x) = x \ln(x)$ & &
\end{tabular}
\end{center}
\label{6Q21}
\end{question}
...
\subQ{c} & $\DS f(x) = \frac{x}{x^2+x+1} \ , \ -2 \leq x \leq 0$ &
...
$\DS \frac{q}{P(q)}$ pour déterminer quelle espèce de fleurs
elles doivent privilégier.  Si $P(q) = 1 + q^2$, trouvez la valeur de $q$
qui maximise le rapport $\DS \frac{q}{P(q)}$.
\label{6Q36}
\end{question}
...
$\DS F(t) = \frac{t}{0.5+t}$ et si $t=T=1$ est le temps
...
l'exemple~\ref{egg_bees}.  Soit $t$ le temps qu'une abeille passe sur
une fleur à aspirer du nectar.  Si
$\DS F(t) = \frac{t^2}{1+t^2}$ et $\tau = 1$, déterminez le
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS x^2y +xy^2 = 3x$ &
\subQ{b} & $\DS \sqrt{xy} = 1 + x^2y$ &
\subQ{c} & $\DS xy^4 +x^2y = x + 3 y$ \\
\subQ{d} & $\DS ye^{y} = x^2e^x$ & & & &
\end{tabular}
\end{center}
\label{6Q45}
\end{question}
...
\subQ{c} & $\DS f(x) = \frac{1}{\sqrt{1+x}}$, $a=3$ et $b =3.1$ &
\subQ{d} & $\DS f(x)= x^{4/3}$, $a = 2$ et $b=8.1$ \\
...
valeurs de $x$ avons-nous $\DS \dydxn{p}{x}{9}(x) >0$?
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \lim_{h\rightarrow 0}\frac{e^h -1 -h}{h^2}$ & 
\subQ{b} & $\DS \lim_{h\rightarrow 0}\frac{e^h -1 -h - h^2/2}{h^3}$ &
\subQ{c} & $\DS \lim_{\theta \rightarrow \pi/2}
...
\begin{question}[\life \eng]
Soit $\DS f(t) = \frac{5t}{e^{2t}}$.  Utilisez la Règle de
...
\item $r(0)=0$,
\item $\DS \lim_{t\rightarrow \infty} r(t) = \infty$ et
\item $r'(t)>0$ pour $c>0$.
\end{enumerate}
...
\begin{center}
\begin{tabular}{*{2}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \lim_{x\rightarrow \infty} \frac{\ln(x)}{e^{3x}}$ &
\subQ{b} & $\DS \lim_{t\rightarrow \infty} \frac{1+t}{1+t+t^2}$ &
\subQ{c} & $\DS \lim_{x\rightarrow 0} \frac{\sin(x)-x}{\cos(x)-1}$
\\[0.9em]
\subQ{d} & $\DS \lim_{z\rightarrow \infty} \frac{3z}{1+\ln(1+z)}$ &
\subQ{e} & $\DS \lim_{x\to 0}\frac{\sin(3x^2)}{x^2}$ &
\subQ{f} & $\DS \lim_{x\to \pi/2} \frac{\cos^2(x)}{(x-\pi/2)^2}$
\\[0.9em]
\subQ{g} & $\DS \lim_{x\to \infty} \frac{e^{1/x}-1}{1/x}$ &
\subQ{h} & $\DS \lim_{x\to 0^+} \frac{\ln(\sin(x))}{\ln(x^4)}$ &
&
\end{tabular}
\end{center}
\label{6Q64}
...
\subQ{a} & $\DS \lim_{x\rightarrow \pi^+} \csc(5x)\sin(3x)$ &
\subQ{b} & $\DS \lim_{x\rightarrow 0^+}
\left( \frac{1}{\sin(x)} -\frac{1}{x} \right)$  &
\subQ{c} & $\DS \lim_{x\rightarrow 0^+} \left(\csc(x) -
\cot(x)\right)$ \\[0.9em]
\subQ{d} & $\DS \lim_{x\to 0} (1-\cos(x))^x$ &
\subQ{e} & $\DS \lim_{x\to 0^+} 7x \cot(3x)$ &
\subQ{f} & $\DS \lim_{x\to \pi} \cot^2(x) (x-\pi)^2$ \\[0.9em]
\subQ{g} & $\DS \lim_{x\to +\infty} \left( x
\cos\left(\frac{1}{x}\right) - x \right)$ &
\subQ{h} & $\DS \lim_{x\to 0} (\cos(x))^{1/x^2}$ &
\end{tabular}
\end{center}
\label{6Q65}
\end{question}
...
$\DS \frac{f(x_i)-f(x_{i-1})}{x_i - x_{i-1}}$ (une
...
x_0 &= 1
\end{align*}
où $\DS f(x) = \frac{x}{1+x}$.  Calculez les valeurs de $x_1$,
...
\subQ{a} Si $\DS f(M) = \frac{M}{2+M}$, nous remarquons que
...
$\DS t(x) = \frac{2 x}{1+x^2}$ où $x$ est le nombre
d'individus.
...
est donné par $\DS \frac{2.5\,x_n}{1+x_n^2}$, donnez un
