\nonumsection{Chapter~\ref{chapLimites} : Limites et fonctions continues}

\nonumsubsection{Limites}

\compileSOL{\SOLUb}{\ref{4Q1}}{
Posons $\DS f(x) = \frac{e^{2x} - 1}{x}$.  Si nous choisissons la
...
$\DS \lim_{n\rightarrow \infty} f(x_n) = 2$.
\[
\begin{array}{c|c|c} 
n & x_n = 1/n & f(x_n) \\
\hline
...
\end{array}
\]
Comme $\DS \lim_{n\rightarrow \infty} f(x_n) = 2$ quelle que
soit la suite $\DS \left\{ x_n \right\}_{n=1}^\infty$ qui
...
$\DS \lim_{t\rightarrow 1^-} p(t) = 0$ car
$p(t) = 0$ pour tous $t<1$.  De même, nous avons que
$\DS \lim_{t\rightarrow 1^+} p(t) = 2$.
Ainsi, la limite $\DS \lim_{t\rightarrow 1} p(t)$ n'existe pas car
...
$\DS \lim_{x\to 0} \frac{1-\cos(x)}{x} = 0$.
...
$\DS \lim_{x\to 1^-}f(x) = 1.5$ et 
$\DS \lim_{x\to 1^+}f(x) = 0.5$. Comme la limite à droite
est différente de la limite à gauche la limite,
$\DS \lim_{x\to 1}f(x)$ n'existe pas.

$\DS \lim_{x\to 2^-}f(x) = 6$ et 
$\DS \lim_{x\to 2^+}f(x) = 5$. Comme la limite à droite est
différente de la limite à gauche la limite,
$\DS \lim_{x\to 2}f(x)$ n'existe pas.
}

\compileSOL{\SOLUb}{\ref{4Q6}}{
Puisque $v$ est une fonction continue, 
$\DS \lim_{t\rightarrow 0} v(t) = v(0) = 1$.
...
Nous avons $\DS \lim_{x\to 0^+} H(x) = 1$ car $H(x_n)=1$
pour toute suite $\DS \{ x_n\}_{n=1}^\infty$ qui tend vers
$0$ avec $x_n \geq 0$.

Nous avons $\DS \lim_{x\to 0^-} H(x) = 0$ car $H(x_n)=0$
pour toute suite $\DS \{ x_n\}_{n=1}^\infty$ qui tend vers
$0$ avec $x_n < 0$.

Puisque $\DS \lim_{x\to 0^+} H(x) \neq \lim_{x\to 0^-} H(x)$,
la limite $\DS \lim_{x\to 0} H(x)$ n'existe pas.
}

\nonumsubsection{Fonctions continues}

\compileSOL{\SOLUb}{\ref{4Q9}}{
\subQ{a}
Puisque $\DS f(t) = \frac{1+t+t^2}{1+t}$ est une fonction continue
à $t=0$, nous avons
\[
...
\subQ{b} Puisque $\DS f(x) = \frac{e^x}{1+x}$ est une
...
\subQ{c} Puisque $\DS f(x) = \frac{(x-2)}{2+\sqrt{2x^2-4}}$
...
\subQ{d} Puisque $\DS f(z) = \frac{3z}{1+\ln(1+z)}$ est une
...
\subQ{e} Puisque $\DS  f(x) = \frac{\cos(\pi/x)}{x^2-5}$ est
...
\subQ{a} La fonction
$\DS f(x) = \frac{(x-3)}{2-\sqrt{x^2-5}}$ n'est pas définie
...
$f$ par l'expression
$\DS \frac{2+\sqrt{x^2-5}}{2+\sqrt{x^2-5}}$.  Comme cette
...
$\DS h(x) = -\frac{2+\sqrt{x^2-5}}{3+x}$ est une fonction
continue à $x=3$ pour calculer la dernière limite.

\subQ{b} Pour déterminer si
$\DS \lim_{x\to 5} \frac{|x-5|}{x^2-25}$ existe, nous devons
...
Puisque
$\DS \lim_{x\to 5^-} \frac{|x-5|}{x^2-25}
\neq \lim_{x\to 5^+} \frac{|x-5|}{x^2-25}$, nous devons conclure que
$\DS \lim_{x\to 5} \frac{|x-5|}{x^2-25}$ n'existe pas.

\subQ{c} La fonction
$\DS f(x) = \frac{3-\sqrt{9-3x}}{8x}$ n'est pas définie
...
$f$ par l'expression
$\DS \frac{3+\sqrt{9-3x}}{3+\sqrt{9-3x}}$.
...
\]
où nous avons utilisé le fait que
$\DS h(x) = \frac{3}{8(3+\sqrt{9-3x})}$ est une fonction
...
\]
où nous avons utilisé le fait que
$\DS h(x) = \frac{-1}{x+1}$ est une fonction
...
\]
Puisque
$\DS \lim_{x\to -3^-} \frac{|x+3|(5+x)}{x+3}
\neq \lim_{x\to -3^+} \frac{|x+3|(5+x)}{x+3}$, nous devons conclure que\\
$\DS \lim_{x\to -3} \frac{|x+3|(5+x)}{x+3}$ n'existe pas.

\subQ{f} Puisque le numérateur et le dénominateur de
$\DS \frac{5x^4 + 3x^2-8}{12x^2-11x-1}$ sont nuls lorsque
...
\]
où nous avons utilisé le fait que
$\DS h(x) = \frac{5x^3+5x^2+8x+8}{12x+1}$ est une fonction
continue à $x=1$ pour calculer la dernière limite.
}

\compileSOL{\SOLUb}{\ref{4Q11}}{
Nous avons $\DS V(t) = e^{\alpha t}$ car $V_0 = 1$ par hypothèses.
...
\]
Puisque
$\DS \lim_{x\to 3^-} f(x) = \lim_{x\to 3^-} (a x^2 + 4x) = 9a + 12$,
$\DS \lim_{x\to 3^+} f(x) = \lim_{x\to 3^+} x^2 + a x = 9 + 3a$ et
...
= \lim_{x\to 3^-} (x+1) = 4 \; ,
\]
$\DS \lim_{x\to 3^+} f(x) = \lim_{x\to 3^+} a x^2 + x + b = 9a +3 +b$
...
\]
Puisque
$\DS \lim_{x\to 4^-} f(x) = \lim_{x\to 4^-} a x^2 + x + b =
16 a + 4 +b$,
$\DS \lim_{x\to 4^+} f(x) = \lim_{x\to 4^+} b \sqrt{x} +
...
Pour toute autre suite $\DS \{t_n\}_{n=1}^\infty$ qui tend
vers $1$, nous avons toujours
$\DS (1-t_n)^{-4} \rightarrow +\infty$ lorsque $n\to \infty$.
Donc $\DS \lim_{x\to 1} (1-t)^{-4} = +\infty$.

Nous aurions pu résonner à partir de la définition de la fonction $h$.
Soit $\DS \{t_n\}_{n=1}^\infty$ une suite qui tend vers $0$.
...
$\DS h(1+t_n) = t_n^{-4} = \frac{1}{t_n^4}$.  Puisque
...
Posons $\DS f(y) = y^2 \ln(y-1)$.  Avant de répondre à la
question, notons que $f(y)$ n'est pas défini pour $y<1$.  Il est donc
impossible de considérer $\DS \lim_{y\rightarrow 1^-} f(y)$
et $\DS \lim_{y\rightarrow 1} f(y)$.

Si nous choisissons la suite $\DS \left\{ x_n \right\}_{n=1}^\infty$
...
de la limite $\DS \lim_{y\rightarrow 1^+} f(y)$ car la
...
= \frac{\DS 1+ \lim_{x\rightarrow \infty}(5/x)
-\lim_{x\rightarrow \infty}(4/x^2)}
{\DS 3 + \lim_{x\rightarrow \infty}(1/x^2)}
= \frac{1}{3}
\]
car $\DS \lim_{x\to \infty}\frac{1}{x^r} = 0 $ pour $r>0$.
...
\subQ{c}
Puisque $\DS \lim_{x\to 0^-} \; \frac{1}{x} = -\infty$ et
$\DS \lim_{x\to 0^+} \; \frac{1}{x} = +\infty$, la limite
$\DS \lim_{x\to 0} \; \frac{1}{x}$ n'existe pas.
...
&= \frac{-4}{\sqrt{\DS 1+ \lim_{x\to \infty}(3/x)}
+ \sqrt{\DS 1 + \lim_{x\to \infty} (7/x)}} \\
...
=\frac{\DS 2 - \lim_{x\rightarrow \infty} e^{-5x}}
{\DS 3 - 4 \lim_{x\rightarrow \infty}e^{-7x}}
= \frac{2}{3}
\]
car $\DS \lim_{x\rightarrow \infty} e^{rx} = 0$ pour $r<0$.
}
...
\]
et $\DS \lim_{x\to \infty} \frac{1}{1+x^2} = 0$, nous avons grâce
au Théorème des gendarmes, théorème~\ref{gendarmeF}, que \\
$\DS \lim_{x\to \infty} \left| \frac{\sin^2(x)}{1+x^2} \right| =0$.
Il s'en suit que
$\DS \lim_{x\to \infty} \frac{\sin^2(x)}{1+x^2} =0$.
}
