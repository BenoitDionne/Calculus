\nonumsection{Chapter~\ref{ChapDerivee} : Dérivée}

\nonumsubsection{Taux de variation}

\compileSOL{\SOLUb}{\ref{5Q1}}{
\subQ{a} \\
\subQ{i}
$\DS \frac{f(1+1)-f(1)}{1} = \frac{2\times 2^2 - 2}{1} = 6$,
\quad
$\DS \frac{f(1+0.5)-f(1)}{0.5} = \frac{2 \times (1.5)^2 - 2}{0.5}
= 5$,\\
$\DS \frac{f(1+0.1)-f(1)}{0.1} = \frac{2 \times (1.1)^2 - 2}{0.1}
= 4.2$ et\\
$\DS \frac{f(1+0.01)-f(1)}{0.01} =
...
\subQ{b}\\
\subQ{i} $\DS \frac{f(0+1)-f(0)}{1} = \frac{e^{2(1)} - 1}{1}
\approx 6.3891$, \quad
$\DS \frac{f(0+0.5)-f(0)}{0.5} = \frac{e^{2(0.5)} - 1}{0.5}
\approx 3.4366$,\\
$\DS \frac{f(0+0.1)-f(0)}{0.1} = \frac{2^{2(0.1)} - 1}{0.1}
\approx 2.2140$ et\\
$\DS \frac{f(0+0.01)-f(0)}{0.01} =
...
\subQ{a} $\DS \frac{p(1)-p(0)}{1} = \frac{1.5^1 - 1}{1} = 0.5$

\subQ{b} $\DS \frac{p(0.1)-p(0)}{0.1} = \frac{1.5^{0.1} - 1}{0.1}
\approx 0.4138$

\subQ{c} $\DS \frac{p(0.01)-p(0)}{0.01} = \frac{1.5^{0.01} - 1}{0.01}
\approx 0.4063$

\subQ{d} $\DS \frac{p(0.001)-p(0)}{0.001} =
...
\subQ{a}
À $t=0$, $\DS H'(0) \approx \frac{H(1)-H(0)}{1-0} = 1.07$.
À $t=1$, puisque que
$\DS \frac{H(0)-H(1)}{0-1} = 1.07$ et 
$\DS \frac{H(2)-H(1)}{2-1} = 1.22$, nous estimons $H'(1)$ par
la moyenne
$\DS H'(1) \approx \frac{1.22+1.07}{2} = 1.145$.
À $t=2$, puisque que
$\DS \frac{H(1)-H(2)}{1-2} = 1.22$ et 
$\DS \frac{H(3)-H(2)}{3-2} = 1.34$, nous estimons $H'(2)$ par la
moyenne
$\DS H'(2) \approx \frac{1.22+1.34}{2} = 1.28$.
...
$\DS H'(10) \approx \frac{H(10)-H(9)}{10-9} = 2.4$\ .
...
\hline
0 & 1 & \rule{0em}{2em} \DS \frac{2^1-2^0}{1-0} = 1 \\[0.7em]
0 & 0.1 & \DS \frac{2^{0.1}-2^0}{0.1-0} = 0.7177\ldots \\[0.7em]
0 & 0.01 & \DS \frac{2^{0.01}-2^0}{0.01-0} = 0.6956\ldots \\[0.7em]
0 & 0.001 & \DS \frac{2^{0.001}-2^0}{0.001-0} = 0.6956\ldots \\
\vdots & \vdots & \qquad \vdots \\
0 & 10^{-5} & \DS \frac{2^{10^{-5}}-2^0}{10^{-5}-0} = 0.6931\ldots
\\[0.7em]
0 & 10^{-6} & \DS \frac{2^{10^{-6}}-2^0}{10^{-6}-0} = 0.6931\ldots \\
\vdots & \vdots & \qquad \vdots \\
 & \downarrow & \downarrow \\
 & 0 & 0.6931\ldots
\end{array}
...
& & \text{(visites/heure)} \\
\hline
2 & 3 & \rule{0em}{2em} \DS \frac{87-57}{3-2} = 30 \\[0.7em]
3 & 4 & \DS \frac{151-87}{4-3} = 64 \\[0.7em]
3 & 5 & \DS \frac{246-87}{5-3} =  \frac{159}{2} = 79.5
\end{array}
\]
...
\nonumsubsection{Dérivée d'une fonction}
...
$\DS \frac{H(1)-H(-1)}{2} = \frac{1}{2}$.  Puisque $H'(x)=0$ pour
...
\nonumsubsection{Calcul des dérivées}
...
$\DS \frac{\Delta L}{\Delta t} = \frac{5}{10} = 0.5$.
...
\end{align*}
pour calculer $\DS \dydx{H}{t}$ lorsque $L=18$.
...
\subQ{a} $\DS f'(x) = \frac{1}{5} x^{1/5 - 1} =
\frac{1}{5} x^{-4/5}$

\subQ{b} $\DS h'(t) = \frac{1}{e}x^{1/e-1}
= \frac{1}{e}x^{(1-e)/e}$

\subQ{c} $\DS g'(z) = 3 \left(3 z^{3-1}\right)
...
\subQ{f} $\DS h'(x) = 135x (x^2-5)^{133/2}$
...
\subQ{h} $\DS f'(t) = \frac{1}{2\sqrt{t}(1+\sqrt{t})^2}$

\subQ{i} $\DS f'(x) = \frac{3}{(3x-1)\ln(2)}$
...
\subQ{o} Nous avons $\DS f(x) = e^{-7x} = f_1(f_2(x))$ où
$f_1(y)=e^y$ et
...
\subQ{r} Nous avons $\DS h(x) = \ln|\ln(x)| = h_1(h_2(x))$ où
...
\subQ{a}
$\DS h'(\theta) = \sec(\theta)(\sec^2(\theta)+\tan^2(\theta))$

\subQ{c} $\DS f'(t) = \frac{\cos(x)}{4+\sin(x)}$

\subQ{d} $\DS g(\theta) = \frac{\sin(\theta) + \theta\cos(\theta)}
{\sqrt{2\theta\, \sin(\theta)}}$

\subQ{e} Nous avons
$\DS F(\theta)=f_1(f_2(f_3(\theta)))$ où
...
\subQ{m} Puisque
$\DS f(t) = \ln\left(2t-\cos(6t)\right)-\ln(t)$, nous trouvons
\[
...
\frac{\DS  \left(\dfdx{1}{x}\right) (1+e^x) -
...
$\DS \dfdx{(a^x)}{x} = a^x \ln(a)$ pour $a>0$.
Donc $\DS \dfdx{(7^x)}{x} = 7^x \ln(7)$.

\subI{ii} Pour utiliser la règle des fonctions composées, notons que
$\DS 7^x = e^{\ln(7^x)} = e^{x\ln(7)} = f_1(f_2(x))$ où
...
\subQ{a} Puisque $\DS y'= \frac{3x^2}{x^3-7}$, nous avons que
$y'(2) = 12$.  L'équation de la droite tangente dans la forme
point-pente est $y - 0 = 12(x -2)$.  Donc $y = 12 x -24$.

\subQ{b} Puisque $\DS y'= \cos(\sin(x))\cos(x)$, nous avons que
...
$\DS \cos(x) = -\frac{\sqrt{3}}{2}$.  Donc
$\DS x = \pm \frac{2\pi}{3} + 2n \pi$ pour $n \in \ZZ$.
}
