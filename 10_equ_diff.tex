...
$\DS k = \frac{p'(t)}{p(t)}$; le taux de croissance divisé
...
de $1.1$.  C'est-à-dire que $\DS p'(t) = 1.1 p(t)$ où $p(t)$
...
$\DS \frac{1}{2} = -1 + C$.  Donc
$\DS C = \frac{3}{2}$ et nous obtenons la solution
...
$\DS p(h) = M \left( 1 - \frac{h}{r}\right)$.  Donc
\[
...
$D \in \RR$.  Nous avons 
bien que $v(t) \to \DS - \sqrt{mg/d}$ lorsque $t$
tend vers l'infini.
...
\int y \dx{y} = - \int \dx{x} \ .
\]
Ce qui donne $\DS \frac{y^2}{2} = - x + d$, la famille de
...
$\DS f(t,q) = 1 - \frac{60}{(20+t)^2} \, q$.  Si nous choisissons
...
l'équation différentielle $\DS \dydx{p}{t} = -9.8 t - 5.0$. 
\label{10Q5}
\end{question}
...
\subQ{a} & $\DS \dydx{p}{t} = 5t^2 + \frac{5}{t^2}$ avec
$p(1)=12$ &
\subQ{b} & $\DS \dydx{M}{t} = t^3 + t^{-3}$ avec $M(2)=8$\\[0.8em]
\subQ{c} & $\DS \dydx{p}{t} = -0.25 t^3$ avec $p(0)= 5$ &
\subQ{d} & $\DS \dydx{M}{t} = 2 t^{-1/2}$ avec $M(0) = 5$
\end{tabular}
\end{center}
\label{10Q8}
\end{question}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \dydx{P}{t} = \frac{5}{1+2t}$ avec $P(0) = 5$ &
\subQ{b} & $\DS \dydx{P}{t} = \frac{5}{(1+t)^2}$ avec $P(0)=0$
\end{tabular}
\end{center}
\label{10Q11}
\end{question}
...
\begin{question}
Montrez que $\DS x(t) = - \frac{1}{2} + \frac{3}{2} e^{2t}$ est une
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.4em}}l@{\hspace{8em}}}l@{\hspace{0.4em}}l}
\subQ{a} & $\DS \dydx{y}{x} = \frac{y}{x}$ &
\subQ{I} & $y = kx$ \\[0.9em]
\subQ{b} & $\DS \dydx{y}{x} = \frac{y\ln y}{x}$ &
\subQ{II} & $y = x^k$ \\[0.9em]
\subQ{c} & $\DS \dydx{y}{x} = \frac{y\ln y}{x \ln x}$  &
\subQ{III} & $y=e^{kx}$
\end{tabular}
\end{center}
\label{10Q24}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \dydx{y}{t} = 2 y \quad , \quad y(0)=3$ &
\subQ{b} & $\DS \dydx{x}{t} = 3 t x^2 \quad , \quad x(1)=-0.4$
 \\[0.7em]
\subQ{c} & $\DS \dydx{h}{t} = 1000-h \quad , \quad h(0)=500$ &
\subQ{d} & $\DS \dydx{g}{x} = \frac{5}{1+2g} \quad , \quad
 g(0)=0$  \\[0.7em]
\subQ{e} & $\DS \dydx{q}{t} = t q^2\,\sin(t^2)
\quad , \quad q(0) = 1$ &
\subQ{f} & $\DS \dydx{y}{t} =\frac{y}{1+x^2} \quad , \quad
 y(0)=2$ \\[0.7em]
\subQ{g} & $\DS \dydx{y}{x} = (y-1)(x+2)  \quad , \quad y(1)=0$ &
\subQ{h} & $\DS \dydx{y}{x} = \frac{6y^2}{1+9x^2} \quad , \quad
y(0) = 1$ \\[0.7em]
\subQ{i} & $\DS \dydx{y}{x} = \frac{\ln(x)}{xy} \quad , \quad
y(1) = 2$ & &
\end{tabular}
\end{center}
\label{10Q26}
...
$\DS \dydx{y}{t} = y^{1.1}$ avec $y(0)=100$ à l'aide de la méthode
...
$\DS \dydx{x}{t} = \frac{x}{1+x}$ avec $x(0)=1$.
...
\begin{question}
Considérons l'équation différentielle $\DS \dydx{x}{t} = 2x-1$.
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \dydx{x}{t} = 1 - x^2$ &
\subQ{b} & $\DS \dydx{y}{t} = \alpha e^{\beta y} - 1$ avec
$\alpha>0$ et $\beta<0$
\end{tabular}
\end{center}
\label{10Q38}
...
\begin{center}
\begin{tabular}{*{1}{l@{\hspace{0.5em}}l@{\hspace{3em}}}l@{\hspace{0.5em}}l}
\subQ{a} & $\DS \dydx{x}{t} = x^2-4x+3$ et $x(0)=5$ &
\subQ{b} & $\DS \dydx{x}{t} = x^2-7x+10$ et $x(0)=7$
\end{tabular}
\end{center}
\label{10Q39}
\end{question}
...
$\DS \dydx{\theta}{t} = \theta\cos(\theta)$.
Tracez le portrait de phases de l'équation différentielle
$\DS \dydx{\theta}{t} = \theta \cos(\theta)$ pour
...
$\DS \dydx{x}{t}=x^2$.  Tracez le graphe de $f(x)=x^2$ et le
...
$\DS \frac{C}{2+C}$ représente la réaction chimique.
...
\begin{question}[\life]
Considérons l'équation différentielle $\DS \dydx{x}{t} = a x - x^2$
...
l'intégrale $\DS \int_0^x f(t) \dx{t} $.
\label{10Q57}
\end{question}
...
différentielle $\DS y'=\frac{3x^2}{2y}$ avec la condition
initiale $y(0)=1$.
