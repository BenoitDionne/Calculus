...
\begin{focus}{\dfn} \index{Équation différentielle}
...
\begin{focus}{\dfn} \index{Solution}
...
\begin{focus}{\dfn}\index{Ordre d'une équation différentielle}
...
\begin{focus}{\dfn} \index{Équation différentielle!séparable}
...
\begin{focus}{\dfn} \index{Condition initiale}
...
\begin{focus}[][Existence et Unicité]{\thm}
...
\begin{focus}{\dfn} \index{Équation différentielle!autonome}
...
\begin{focus}{\dfn} \index{Famille de courbes}
...
\begin{focus}{\dfn} \index{Famille de courbes orthogonales}
...
\begin{focus}[][Méthode d'Euler]{\mth} \index{Méthode d'Euler}
