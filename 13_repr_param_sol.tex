\nonumsection{Chapter~\ref{chapReprParam} : Représentations paramétriques des courbes}

\nonumsubsection{Droite tangente à une courbe}

\nonumsubsection{Longueur d'une courbe}
