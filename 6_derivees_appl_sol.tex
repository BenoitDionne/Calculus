\nonumsection{Chapter~\ref{chapApplDer} : Applications de la dérivée}

\nonumsubsection{Dérivées d'ordres supérieures}

\compileSOL{\SOLUb}{\ref{6Q1}}{
\subQ{a} $h'(y) = 10y^9 - 9 y^8$ et $h''(y) = 90y^8 - 72 y^7$.

\subQ{b}  Puisque $\DS f(x) = \frac{3+x}{2x}
= \frac{3}{2}x^{-1} + \frac{1}{2}$, nous avons
$\DS f'(x) = -\frac{3}{2} x^{-2}$ et
$\DS f''(x) = 3 x^{-3}$.
...
nous obtenons
\[
f'(x) = \frac{\DS \left(\dfdx{(1+x)}{x}\right) e^x  -
(1+x)\left(\dfdx{e^x}{x}\right)}{(e^x)^2} =
\frac{e^x  - (1+x)e^x}{e^{2x}} = \frac{-x}{e^x}
\]
et
\[
f''(x) = \frac{\DS \left(\dfdx{(-x)}{x}\right) e^{x}
...
Ainsi
\begin{align*}
f'(z) &= \frac{\DS \left(\dfdx{(1+e^{-z})}{z}\right)
...
Ainsi,
\begin{align*}
f''(z) &= -\frac{\DS \left(\dfdx{(e^{-z}+2+e^z)}{z}\right)
...
\begin{align*}
f'(x) &=
\frac{\DS \left(\dfdx{(2+x^3)}{x}\right)
...
\begin{align*}
f''(x) &=
\frac{\DS \left(\dfdx{(x^4+3x^2-4x)}{x}\right)
...
$C_2=100$.  Nous obtenons $\DS d(t) = -11.44 t^2 + 100$.
...
\nonumsubsection{Graphes de fonctions}
...
$\DS v(t) = d'(t) = -2.15\times 10^{-3} t + 5$ m/s et le
déplacement en fonction du temps est
$\DS d(t) = -1.075\times 10^{-3} t^2 + 5 t + 100$ m.
...
$\DS t = 5/( 2.15 \times 10^{-3}) \approx 2,325.581$ s.
...
$\DS d(t)= -1.075\times 10^{-3} t^2 + 5 t + 100 = 100$ où,
si vous préférez, $\DS -1.075\times 10^{-3} t^2 + 5 t = 0$.
...
De plus, $\DS \lim_{t\rightarrow \infty} M(t) = -\infty$.
...
$\DS \rho(t) = \frac{M(t)}{V(t)} = \frac{1 + t^2}{1+t}$ g/cm$^3$.

\subQ{b}
\begin{align*}
\rho'(t) &= \frac{\DS \left(\dfdx{(1+t^2)}{t}\right) (1+t) - (1+t^2)
...
$\DS \lim_{t\rightarrow \infty} \rho(t)
...
$\DS \lim_{x\rightarrow \infty} h(x) = +\infty$ et
$\DS \lim_{x\rightarrow -\infty} h(x) = -\infty$.
...
\subQ{b} Nous avons $\DS h'(x) = 3x^2 -12 x -15 = 3(x-5)(x+1)$ et
$\DS h''(x)=6x-12$.
...
\subQ{d} Nous avons $\DS f'(x) = -e^x + (1-x)e^x = - x e^x$ et
$\DS f''(x) = - e^x - x e^x = -(1+x)e^x$.
...
$\DS \left\{x_n\right\}_{n=0}^\infty$ qui tendent vers plus ou
...
\subQ{e} Nous avons $\DS g(z) = \frac{e^z}{z^2} = z^{-2} e^z$.
Ainsi,
\begin{align*}
...
\subQ{i} Nous avons $\DS f'(x) = \frac{3x^2}{(1+x^3)^2}$ et
$\DS f''(x) = \frac{6x(1-2x^3)}{(1+x^3)^3}$.
...
=\frac{1}{\DS \lim_{x\rightarrow \pm\infty}(1/x^3) + 1} = 1 \ , \\
\lim_{x\rightarrow -1^+} f(x) &= +\infty
\intertext{et}
\lim_{x\rightarrow -1^-} f(x) &= -\infty \ .
\end{align*}
Nous ne pouvons pas utiliser la Règle de l'Hospital pour évaluer les
limites $\DS \lim_{x\rightarrow -1^+} f(x)$ et
$\DS \lim_{x\rightarrow -1^-} f(x)$.  Pourquoi?
...
Nous avons que $\DS f(x)= \frac{2x-3}{x^3} = 0$ pour $x = 3/2$.
Il découle de
\[
...
Nous avons que $\DS f(x)= \frac{2(x^2-3)}{x^3} = 0$ à
...
Nous avons que $\DS f(x)= \frac{e^x}{x-1} \neq 0$ pour tout $x$.
Il découle de
\begin{align*}
...
\]
car $\DS \lim_{x\to \infty} 1/x^r = 0$ pour $r>0$, nous avons que
...
De même, $\DS \lim_{x\to -1^+} f(x)
= \lim_{x\to -1^+} \frac{x}{x^3+1} = -\infty$
car $x$ approche $-1$ et $x^3+1>0$ approche $0$ lorsque $x \to -1^+$.
La droite $x=1$ est donc une asymptote verticale.

Il découle de $\DS f'(x) = \frac{-2x^3+1}{(x^3+1)^2}$ et
$\DS f''(x) = \frac{6x^2(x^3-2)}{(x^3+1)^3}$ que
...
Nous avons que $\DS \lim_{x \to +\infty} f(x) = \infty$ car
...
\subQ{b}
Nous avons $\DS f'(\theta) = 1 - 3\sin(\theta)$ et
$\DS f''(\theta)= -3\cos(\theta)$.  La fonction $f$ et ses dérivées
...
\subQ{c}
Nous avons $\DS h'(t) = \left(\cos(t)- \sin(t)\right) e^{-t}$ et
$\DS h''(t)= -2\cos(t)e^{-t}$.  La fonction $h$ et ses dérivées
sont définies sur toute la droite réelle.
...
\end{tabular}
\end{center}
Nous avons $\DS S(x) = \frac{x}{1+0.5x^2}$ et
$\DS S'(x) = \frac{1-0.5x^2}{(1+0.5x^2)^2}$.
...
$N(x) = m x + b$ où
$\DS m = \frac{104-100}{49-50} = -4$ et $b=300$ (pour avoir
$N(50)=100$).
...
$\DS f'(x) = \frac{1-x^2}{(x^2+x+1)^2}=0$, sont $x=\pm 1$.
...
Nous avons $\DS f'(x) = 15x^2 - 30x + 10$.  Les points
...
Soit $\DS f(q) = \frac{q}{P(q)} = \frac{q}{1+q^2}$.  Nous avons
...
Nous avons $\DS f'(q) = \frac{1-q^2}{(1+q^2)^2}$.  La fonction $f$
a un seul point critique positif, c'est $q=1$.  De plus,
$\DS \lim_{q\to \infty} f(q) = 0$.  Nous obtenons le tableau suivant.
\[
\begin{array}{c|c|c|c|c|c}
...
$\DS H_1 = r\sqrt{2 + \frac{2}{\sqrt{5}}} = 1.7013\ldots r$ et
$\DS H_2 = r\sqrt{2 - \frac{2}{\sqrt{5}}} = 1.05146\ldots r$.
...
$\DS r\sqrt{2 - \frac{2}{\sqrt{5}}}$ unités.
}
...
$\DS x=\frac{3}{1+\sqrt[3]{3}} = 1.228375690$ et la valeur de
l'illumination est
$\DS I\left(\frac{3}{1+\sqrt[3]{3}}\right) = 1.618555576\,kP$.
}

\compileSOL{\SOLUb}{\ref{6Q39}}{
Nous avons $\DS F(t) = \frac{\beta t}{t+\alpha}$ avec $\beta=1$ et
...
\[
\begin{array}{c|c|c}
n & t_n & \DS t_{n+1} \approx t_n - \frac{p(t_n)}{p'(t_n)} \\[0.7em]
\hline
0 & 1.5 & 1.5217391304 \\
...
Puisque $\DS \dydx{x}{t}(t) = 0.5$ m/s pour tout $t$, nous avons
\[
...
$\DS \frac{|\overline{eb}|}{|\overline{ab}|} =
\frac{|\overline{dc}|}{|\overline{ac}|}$; c'est-à-dire,
$\DS \frac{|\overline{eb}|}{h} = \frac{6}{4}$.  Donc
$|\overline{eb}| = 3h/2$.
...
\]
puisque $\DS \dydx{V}{t}(t) = 0.1$ m$^3$/min pour tout $t$.
Ainsi, $\DS \dydx{h}{t}(\tau) \approx 0.00105$ m/min.
}

\compileSOL{\SOLUa}{\ref{6Q43}}{
$5$ révolutions par minute se traduit par
$\DS \dydx{\theta}{t}(t) = 10\pi$ radians/min pour tout $t$.

Si nous dérivons la relation $\DS \tan(\theta) = \frac{x}{4}$,
nous obtenons
\[
...
\nonumsubsection{Dérivées implicites}
...
\subQ{a} $\DS y' = \frac{3-2xy-y^2}{x^2+2xy}$

\subQ{b} $\DS y' = \frac{4xy\sqrt{xy} - y}{x-2x^2\sqrt{xy}}$

\subQ{c} $\DS y' = \frac{1-y^4-2xy}{4xy^3 + x^2 -3}$
}

\nonumsubsection{Approximation locale des fonctions}
...
= \frac{\DS 1-\lim_{x\to 1} (1/x)}
{\DS 2-\lim_{x\to 1} (2/x)} = \frac{1}{2} \ .
\]
...
$\DS f'(x) = \frac{3}{4} x^{-1/4}$ et
$\DS f''(x) = -\frac{3}{16} x^{-5/4}$, nous obtenons
\[
...
\subQ{c} Puisque $\DS f(x) = (1+x)^{-1/2}$,
$\DS f'(x) = -\frac{1}{2}(1+x)^{-3/2}$,
$\DS f''(x) = \frac{3}{4}(1+x)^{-5/2}$ et
$\DS f'''(x) = -\frac{15}{8}(1+x)^{-7/2}$, le polynôme
...
\]
Donc $\DS \frac{f''(3)}{2} = 0$ et
$\DS \frac{f^{(4)}(3)}{24} = \frac{1}{3}$.  nous obtenons
$f''(3) = 10$ et $f^{(4)}(3) = 8$.
}
...
Puisque $\DS \dfdxn{\left(x^k\right)}{x}{9} = 0$ pour $k < 9$ et
$\DS \dfdxn{\left(x^9\right)}{x}{9} = 9!$, nous avons que
$\DS \dydxn{p}{x}{9}(x) = 7\times 9! >0$ pour tout $x$.
}

\nonumsubsection{Comportement asymptotique}

\compileSOL{\SOLUb}{\ref{6Q63}}{
Pour répondre à cette question, nous utilisons la Règle de l'Hospital.

\subQ{a}
Nous avons $\DS \lim_{x\to\infty} f(x) = +\infty$ et
$\DS \lim_{x\to\infty} g(x) = +\infty$.  Ainsi,
\[
...
\subQ{b}
Nous avons $\DS \lim_{x\to\infty} f(x) = 0$ et
$\DS \lim_{x\to\infty} g(x) = 0$.  Ainsi,
\[
\lim_{x\to \infty} \frac{f(x)}{g(x)} 
...
\subQ{c}
Nous avons $\DS \lim_{x\to 0^+} f(x) = +\infty$ et
$\DS \lim_{x\to 0^+} g(x) = +\infty$.  Ainsi,
\[
...
\subQ{b}  Puisque
$\DS \lim_{t\rightarrow \infty} \frac{1}{t^n} = 0$ pour
$n>0$, nous avons
\[
...
\subQ{f} $\DS \lim_{x\to \pi/2} \frac{\cos^2(x)}{(x-\pi/2)^2}$
...
\subQ{g}
$\DS \lim_{x\to \infty} \frac{e^{1/x}-1}{1/x}$ est une limite du
...
l'origine et donc que $\DS \lim_{x\to 0}\cos(3x) = \cos(0) = 1$.

Un autre approche est d'utiliser
$\DS \lim_{y\to 0} \frac{y}{\sin(y)} = 1$.  Donc
\begin{align*}
...
que $\DS \lim_{x\to \pi}\cos(x) = \cos(\pi) = -1$ et
$\DS \lim_{x\to \pi}\sin(x) = \sin(\pi) = 0$.
...
\nonumsubsection{Méthode de Newton}
...
\nonumsubsection{Systèmes dynamiques discrets}
...
= - \ln(5) \ .
\end{align*}
Donc $\DS i \approx \frac{-\ln(5)}{\ln(0.7)} = 4.512338026$.
...
\]
car $\DS \lim_{n\to \infty} r^n = 0$ pour $|r|<1$.  La
...
$b=0$. Nous avons donc $\DS v_{i+1} = (3/2) v_i$.

Pour compléter le tableau, notons que
$\DS v_1 = (3/2) \times 1420 = 2130$.
...
solution du système dynamique discret $\DS v_{i+1} = (3/2) v_i$ est
$\DS v_i = (3/2)^i v_0 = 1420 \times (3/2)^i$ pour $i\geq 0$.  Donc
$\DS v_6 = 1420 \times (3/2)^6 = 16174.6875$.
...
Nous avons donc $\DS p_{i+1} = (3/4) p_i + 1$.

La fonction itérative est $\DS f(x) = (3/4) x + 1$.  Pour
...
La fonction itérative est $\DS f(z) = 0.5 z + 8$.
...
l'équation $\DS x = 2 x - 10^6$, soit $x= 10^6$.  La solution du
...
solution de l'équation $\DS x = 2 ( x - 10^6)$, soit
...
Nous avons $x_0 = 1$, $\DS x_1 = f(x_0) = \frac{1}{2}$, 
$\DS x_2 = f(x_1) = \frac{1}{3}$,
$\DS x_3 = f(x_2) = \frac{1}{4}$, \ldots\
Nous pouvons conjecturer que la solution est
$\DS x_i = \frac{1}{i+1}$.  Pour démontrer que notre
conjecture est vrai, il faut vérifier que l'équation
$\DS x_{i+1} = \frac{x_i}{1+x_i}$ est satisfaite avec
$\DS x_i = \frac{1}{i+1}$.  Effectivement,
\[
...
La fonction itérative est $\DS f(x) = \frac{x}{x-1}$ pour
$x>1$.  Les point d'équilibre positifs du système dynamique discret
sont les solutions de l'équation $\DS p = f(p) = \frac{p}{p-1}$.
...
La fonction itérative est $\DS f(x) = \frac{x}{x +1}$.  Le
...
$\DS f(x) = \frac{1.5x}{1.5x + 2(1-x)} = \frac{1.5x}{2-0.5x}$.
Nous avons $\DS f'(x) = \frac{3}{(2-0.5x)^2}$.
...
\]
La fonction itérative est $\DS g(M) = \frac{2M}{2+M} + 1$.
Notons que $G(2)=2$.  Ce qui confirme que $M=2$ est un point d'équilibre.

Nous déduisons de $\DS g'(M) = \frac{4}{(2+M)^2}$ que
...
$f(x) = \mu x(1-x^2)$.  Ainsi, $\DS f'(x) = \mu (1-3x^2)$ et
...
$\DS x = \pm \sqrt{ 1 - 1/\mu}$ pour $\mu\geq 1$.

Le point d'équilibre positif est donc
$\DS p = \sqrt{ 1 - 1/\mu}$ pour $\mu > 1$.

Nous avons toujours $\DS f'(x) = \mu (1-3x^2)$.  Ainsi,
\[
...
$\DS f(x) = \frac{2 x^2}{1+x^2}$.  Les points d'équilibre sont les
...
\subQ{d} Puisque $\DS f'(x) = \frac{4x}{(1+x^2)^2}$, nous avons que
...
$\DS f(x) = \frac{6 x^2}{7+x^2}$ car $x_{n+1} = f(x_n)$.

\subQ{b} Les points d'équilibre sont les solutions de l'équation
$\DS f(x) = \frac{6 x^2}{7+x^2} = x$.  Nous avons
\[
...
\subQ{c} Nous avons $\DS f'(x) = \frac{84x}{(7+x^2)^2}$.
...
$1$) sera $\DS S_1= \frac{100}{N_0} = \frac{100}{20} = 5$.
...
$\DS S_2= \frac{100}{N_1} = \frac{100}{4} = 25$.
...
$\DS S_3= \frac{100}{N_2} = \frac{100}{24} = 4.1\overline{6}$.
...
$\DS f(N) = \frac{100}{N} - 1$.  Les points d'équilibre sont les
solutions de $f(N) = N$.
\[
...
$\DS N_1 = \frac{1}{2}\left(-1 + \sqrt{401}\right) \approx 9.5124922$
et $\DS N_2 = \frac{1}{2}\left(-1 - \sqrt{401}\right)$.  Puisque
$N_2<0$, nous pouvons l'ignorer car nous ne pouvons pas avoir un
nombre négatif de graines.

\subQ{d} Nous avons $\DS f'(N) = -\frac{100}{N^2}$, donc
$\DS f'(N_1) = - \frac{100}{N_1^2} \approx -1.1051249$.  Puisque
...
Puisque $\DS R'(h) = \frac{1}{2} \left( 1 - 2h\right)$, il n'y a
...
Puisque $\DS R'(h) = \left( 3 - 4h\right)/5 = 0$ seulement
...
$\DS p(3/4) = \left(3- 2(3/4)\right)/5 = 3/10 = 0.3$.  
...
le point d'équilibre $\DS p = \sqrt{\frac{1-2h}{3}}$.
...
qui maximise $\DS R(h) = h\; p = h\sqrt{\frac{1-2h}{3}}$
...
$\DS f(x) = 1.5 x(1-x^2) - x/3$.  Donc
$\DS f'(x) = 7/6 - 9x^2/2$.
Puisque $|f'(p)| = 2/3 < 1$, le point d'équilibre
$\DS p = 1/3$ est stable.  À long
...
qui maximise
$\DS R(h) = h\, p(h) = \frac{h(1-h)^{1/3}}{\sqrt[3]{2}}$ pour
$0\leq h \leq 1$.
...
d'équilibre $\DS p(3/4) = 1/2$ pour le système
dynamique discret
\[
...
\subQ{a} La fonction itérative du système dynamique discret est
$\DS f(x) = \frac{2.5 x}{1+x} - h x$.  Les points d'équilibre sont
les solutions de
\[
  f(x)=\DS \frac{2.5 x}{1+x} - h x=x \ .
\]
L'origine $x=0$ est une point d'équilibre.  Si $x\neq 0$, nous pouvons
alors diviser les deux côtés de l'égalité précédente pour obtenir
$\DS \frac{2.5}{1+x} - h=1$.  La solution
$\DS x = p(h) = \frac{3-2h}{2+2h}$ de cette dernière
équation est le deuxième point d'équilibre.

Pour que le point d'équilibre $\DS p(h) = \frac{3-2h}{2+2h}$ soit
...
Puisque $\DS R'(h) = \frac{-2h^2-4h+3}{2(1+h)^2} = 0$
...
$\DS f(x) = \frac{2.5 x}{1+x} - h_1 x$
et le point d'équilibre positif du système dynamique discret
$\DS N_{i+1} = f(N_i) = \frac{2.5N_1}{1+N_i} - h_1 N_i$ est
$\DS p(h_1) = \frac{3-2h_1}{2+2h_1} \approx 0.58113883$.

La dérivée de la fonction itérative est
$\DS f'(x) = \frac{2.5}{(1+x)^2} - h_1$.  Ainsi,
\[
...
$\DS x = p(h) = \ln\left(\frac{5}{2+2h}\right)$.

Pour que le point d'équilibre
$\DS p(h)=\ln\left(\frac{5}{2+2h}\right)$ soit non négatif,
il faut avoir $\DS \frac{5}{2+2h} \geq 1$.  Ce qui donne
