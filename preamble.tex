...
\newcommand{\dfn}{D\'efinition}
\newcommand{\prp}{Proposition}
\newcommand{\thm}{Th\'eor\`eme}
\newcommand{\crl}{Corollaire}
\newcommand{\lmm}{Lemme}
...
\newenvironment{focus}[2][TTT]{%
  ...
  \ifthenelse{\equal{\dfn}{#2}}{\renewcommand{\focuscolor}{purple}}{%
    \ifthenelse{\equal{\mth}{#2}}{\renewcommand{\focuscolor}{red}}{%
  ...
  \begin{tcolorbox}[enhanced,breakable,colback=\focuscolor!5!white,colframe=\focuscolor!50!white,colbacktitle=\focuscolor!50!white,coltitle=black,drop fuzzy shadow=black!50!white,title={\bfseries #2 \thefocus}%
    \ifthenelse{\equal{TTT}{#1}}{}{%
      ...
      \expandarg%
      \IfSubStr{#1}{+}{%
        \renewcommand{\argA}{\StrBefore{#1}{+}}%
        \renewcommand{\argB}{\StrBehind{#1}{+}}%
      }{}%
      \IfBeginWith{#1}{+}{\ \argB}{\ ({\bfseries \argA}) \argB}}]%
...
\newenvironment{meth}[1][TTT]{%
\ifthenelse{\equal{TTT}{#1}}{\begin{focus}{\mth}}{\begin{focus}[#1]{\mth}}%
}{\end{focus}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For sections and subsections without a number
%
% You will have to add after the title of the chapter the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% To produce the questions at the end of the chapters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\opensource}{
  ...
  \noindent Sauf indication contraire, ce manuel est mis \`a disposition selon
  ...
  Un \'etang sur l'\^Ile de Montr\'eal, photo par Patrice Dionne.
