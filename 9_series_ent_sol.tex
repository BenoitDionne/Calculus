\nonumsection{Chapter~\ref{chapSerEnt} : Séries entières}

\nonumsubsection{Convergence des séries entières}

\compileSOL{\SOLUb}{\ref{9Q1}}{
\subQ{a} Nous avons une série de la forme
$\DS \sum_{n=1}^\infty a_n x^n$ avec
$\DS a_n = \frac{1}{n^2}$.   Puisque
\[
...
$\DS \sum_{n=1}^\infty (-1)^n b_n$ avec
$\DS b_n = \frac{1}{n^2}$ qui satisfait
$b_n > b_{n+1} \geq 0$ et
$\DS \lim_{n\rightarrow \infty} b_n = 0$).
L'intervalle de convergence est donc $[-1,1]$.

\subQ{b} Nous avons une série de la forme
$\DS \sum_{n=1}^\infty a_n x^n$ avec
$\DS a_n = \frac{n^2}{10^n}$.   Puisque
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| =
...
$\DS \sum_{n=1}^\infty a_n (x+2)^n$ avec
$\DS a_n = \sqrt{n}$.   Puisque
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| =
...
$\DS \sum_{n=1}^\infty a_n (x-1)^n$ avec
$\DS a_n = (-1)^n \,\frac{1}{n\,4^n}$.   Puisque
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| =
...
qui converge (c'est une série alternée de la forme
$\DS \sum_{n=1}^\infty (-1)^n b_n$ avec
$\DS b_n = \frac{1}{n}$ qui satisfait
$b_n > b_{n+1} \geq 0$ et $\DS \lim_{n\rightarrow \infty} b_n = 0$). 
...
$\DS \sum_{n=1}^\infty a_n (x+3)^n$ avec
$\DS a_n = \frac{(-5)^n}{n}$.  Puisque
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n}\right| = 
\lim_{n\rightarrow \infty}
...
$\DS \sum_{n=1}^\infty \frac{1}{n}$ qui diverge.  C'est la
série $\DS \sum_{n=1}^\infty \frac{1}{n^p}$ avec
$p \leq 1$ qui diverge.

Pour $x=-14/5$, nous avons la série
$\DS \sum_{n=1}^\infty \frac{(-1)^n}{n}$.  C'est une série
alternée de la forme $\DS \sum_{n=1}^\infty (-1)^n b_n$
avec $\DS b_n = 1/n$, une suite de termes
...
$\DS \sum_{n=1}^\infty \frac{(-1)^n}{n^2}$ qui converge.
C'est une série alternée de la forme
$\DS \sum_{n=1}^\infty (-1)^n b_n$
avec $\DS b_n = 1/n^2$, une suite de termes
positifs décroissante qui converge vers $0$.  La
série alternée converge donc.

Pour $x=7/3$, nous avons la série
$\DS \sum_{n=1}^\infty \frac{1}{n^2}$.  C'est la
série $\DS \sum_{n=1}^\infty \frac{1}{n^p}$ avec
$p > 1$ qui converge.
...
$\DS \sum_{n=1}^\infty a_n (x-2)^n$ avec
$\DS a_n = \frac{1}{3^n\sqrt{n}}$.  Puisque
\begin{align*}
\lim_{n\to \infty} \left|\frac{a_{n+1}}{a_n}\right|
...
$\DS \sum_{n=1}^\infty \frac{(-3)^n}{3^n\sqrt{n}}
= \sum_{n=1}^\infty \frac{(-1)^n}{\sqrt{n}}$.
C'est une série alternée de la forme
$\DS \sum_{n=1}^\infty (-1)^n a_n$ avec 
$\DS a_n = \frac{1}{\sqrt{n}}$, , une suite de termes
positifs décroissante qui converge vers $0$.  La
série alternée converge donc.
...
$\DS \sum_{n=1}^\infty a_n (x-c)^n$.
Soit $\DS a_n = \frac{(-1)^n x^{2n-1}}{(2n-1)!}$.  Nous avons
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| =
\lim_{n\rightarrow \infty}
...
\]
La série
$\DS \sum_{n=1}^\infty \frac{(-1)^n x^{2n-1}}{(2n-1)!}$
...
exactement une série de la forme
$\DS \sum_{n=1}^\infty a_n (x-c)^n$.
Soit $\DS a_n = (-1)^n \,\frac{x^{2n+1}}{2n+1}$.  Nous avons
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| =
...
$\DS \sum_{n=0}^\infty (-1)^n \,\frac{x^{2n+1}}{2n+1}$
...
\nonumsubsection{Fonctions définies par des séries}
...
Pour $x=3$ nous avons la série $\DS \sum_{n=1}^\infty n$ qui
diverge car le terme général $n$ ne converge pas vers $0$ lorsque
$n \to \infty$.  Pour $x=-3$, nous avons la série 
$\DS \sum_{n=1}^\infty (-1)^n n$ qui aussi diverge pour la
...
$\DS \int_0^2 g(x) \dx{x}$ existe car l'intervalle
...
série qui représente $\DS \int_0^2 g(x) \dx{x}$.  Ainsi,
\[
...
qui converge (c'est une série alternée de la forme
$\DS \sum_{n=1}^\infty (-1)^n b_n$ avec
$\DS b_n = \frac{1}{n+1}$ qui satisfait
$b_n > b_{n+1} \geq 0$ et $\DS \lim_{n\rightarrow \infty} b_n = 0$). 
...
\end{equation}
C'est une série alternée de la forme
$\DS \sum_{n=0}^\infty (-1)^n b_n$ où les termes
$\DS b_n = \frac{1}{(n+1)2^{2n+2}}$ forment une suite
...
$\DS e^u = \sum_{n=0}^\infty \frac{1}{n!}u^n$ pour tout $u$.
Ainsi $\DS e^{x^3} = \sum_{n=0}^\infty \frac{1}{n!}x^{3n}$
pour tout $x$.

Nous savons que le coefficient de $x^9$ (i.e.\ $1/3!$) dans la série
de Taylor de $e^{x^3}$ est donné par la formule
$\DS \frac{1}{9!}\dydxn{f}{x}{9}(0)$.  Donc
\[
...
multiplions $\DS 1 + x^2 + \frac{1}{2}x^4 + \ldots$ et
$\DS 1 - \frac{1}{2}x^2 + \frac{1}{24}x^4 + \ldots$ pour
obtenir
$\DS 1 + \frac{1}{2} x^2 + \frac{1}{24} x^4 + ...$
...
Nous avons une série de la forme $\DS \sum_{n=0}^\infty a_n$ avec
$\DS a_n = (-1)^n \frac{1}{2n+3} x^{2n+3}$.  Puisque
\[
\lim_{n\rightarrow \infty} \left| \frac{a_{n+1}}{a_n}\right| = 
\lim_{n\rightarrow \infty}
\frac{2n+3}{2n+5} x^2
...
Il faut considérer les extrémités de l'intervalle $]-1,1[$.
Pour $x=1$, nous avons la série
$\DS \sum_{n=0}^\infty (-1)^n \frac{1}{2n+3}$  C'est une
série alternée de la forme
$\DS \sum_{n=0}^\infty (-1)^n b_n$ 
...
$\DS \sum_{n=0}^\infty (-1)^{n+1} \frac{1}{2n+3}$ qui, comme la
...
$\DS \sum_{n=0}^\infty (-1)^n b_n$ où les termes\\
$\DS b_n = \frac{0.5^{4n+5}}{(2n+1)(4n+5)}$ forment une suite
décroissante de termes positifs qui tend vers $0$ lorsque
...
\nonumsubsection{Série du binôme}
...
\begin{align*}
\DS \binom{1/2}{0} &= 1 \ ,\\
\DS \binom{1/2}{1} &= \frac{1/2}{1!} = \frac{1}{2} \ , \\
\DS \binom{1/2}{2} &= \frac{1/2(1/2-1)}{2!} = \frac{-1}{2^2
\, 2!} \ , \\
\DS \binom{1/2}{3} &= \frac{1/2(1/2-1)(1/2-2)}{3!}
= \frac{(-1)(-3)}{2^3 \, 3!} \ , \\
\DS \binom{1/2}{4} &= \frac{1/2(1/2-1)(1/2-2)(1/2-3)}{4!}
= -\frac{(-1)(-3)(-5)}{2^4\,4!} \ , \\
\DS \binom{1/2}{5} &= \frac{1/2(1/2-1)(1/2-2)(1/2-3)(1/2-4)}{5!} =
\frac{(-1)(-3)(-5)(-7)}{2^5\,4!} \ , \\
  \vdots & \qquad  \vdots
\end{align*}
...
\DS \frac{p(p-1)(p-2)(p-3)\ldots(p-n+1)}{n!} &
...
\begin{align*}
\DS \binom{1/3}{0} &= 1 \ , \\
\DS \binom{1/3}{1} &= \frac{1/3}{1!} = \frac{1}{3} \ , \\
\DS \binom{1/3}{2} &= \frac{(1/3)(1/3-1)}{2!} =
\frac{(-2)}{3^2\, 2!} \ , \\
\DS \binom{1/3}{3} &= \frac{(1/3)(1/3-1)(1/3-2)}{3!}
= \frac{(-2)(-5)}{3^3\, 3!} \ , \\
\DS \binom{1/3}{4} &= \frac{(1/3)(1/3-1)(1/3-2)(1/3-3)}{4!}
= \frac{(-2)(-5)(-8)}{3^4\, 4!} \ , \\
\vdots & \qquad \vdots
\end{align*}
Par induction, nous trouvons que
\[
\DS \binom{1/3}{n} = \frac{(1)(-2)(-5)(-8)\ldots(4-3n)}{3^n n!}
\]
pour $n>0$.  Donc
\[
...
\]
Avec $p=-1/2$, nous obtenons la série de MacLaurin de
$\DS \frac{1}{\sqrt{1+u}}$; c'est-à-dire,
\[
...
\DS \binom{-1/2}{0} &= 1 \ , \\
\DS \binom{-1/2}{1} &= \frac{-1/2}{1!} = \frac{-1}{2} \ , \\
\DS \binom{-1/2}{2} &= \frac{-1/2(-1/2-1)}{2!} =
\frac{(-1)(-3)}{2^2\, 2!} \ , \\
\DS \binom{-1/2}{3} &= \frac{-1/2(-1/2-1)(-1/2-2)}{3!} =
\frac{(-1)(-3)(-5)}{2^3\, 3!}\ , \\
\DS \binom{-1/2}{4} &= \frac{-1/2(-1/2-1)(-1/2-2)(-1/2-3)}{4!}
...
Nous avons une séries alternée $\DS \sum_{n=0}^\infty (-1)^n a_n$,
où $a_0 = 1/10$ et
$a_n = \DS \frac{(1)(3)(7)(9)\ldots(2n-1)}
{(3n+1)\, 2^n\, 10^{3n+1}\, n!}$ pour $n>0$.
Les termes $\DS a_n$ forment une suite décroissante
