...
chapitre~\ref{chapReprParam} sur les représentations paramétriques de
...
Le chapitre~\ref{chapReprParam} est fondamental pour l'étude du calcul
...
les multiples de $\DS 10^3$.  Ainsi,
\[
105\ 456\ 263,456 =
...
nombre et la virgule sépare les multiples de $\DS 10^3$.  Nous écrivons donc
\[
